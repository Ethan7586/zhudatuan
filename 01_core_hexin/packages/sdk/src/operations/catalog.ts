...
function bindPoolsRead(client: OperationExecutor): OperationMethod<"catalog.pools.read"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.pools.read","method":"GET","path":"/api/v1/catalog/pools","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindPoolsAttach(client: OperationExecutor): OperationMethod<"catalog.pools.attach"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.pools.attach","method":"PUT","path":"/api/v1/catalog/pools/{poolid}/bindings/{scopeid}","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindPoolsDetach(client: OperationExecutor): OperationMethod<"catalog.pools.detach"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.pools.detach","method":"DELETE","path":"/api/v1/catalog/pools/{poolid}/bindings/{scopeid}","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindPoolsAllocate(client: OperationExecutor): OperationMethod<"catalog.pools.allocate"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.pools.allocate","method":"POST","path":"/api/v1/catalog/pools/{poolid}/allocations","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindProductsCreate(client: OperationExecutor): OperationMethod<"catalog.products.create"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.products.create","method":"POST","path":"/api/v1/catalog/products","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindProductsUpdate(client: OperationExecutor): OperationMethod<"catalog.products.update"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.products.update","method":"PATCH","path":"/api/v1/catalog/products/{productid}","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindProductsArchive(client: OperationExecutor): OperationMethod<"catalog.products.archive"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.products.archive","method":"DELETE","path":"/api/v1/catalog/products/{productid}","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindListingsRead(client: OperationExecutor): OperationMethod<"catalog.listings.read"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.listings.read","method":"GET","path":"/api/v1/catalog/listings","audience":"member","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindListingsPublish(client: OperationExecutor): OperationMethod<"catalog.listings.publish"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.listings.publish","method":"PUT","path":"/api/v1/catalog/listings/{listingid}/publication","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindListingsUnpublish(client: OperationExecutor): OperationMethod<"catalog.listings.unpublish"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.listings.unpublish","method":"DELETE","path":"/api/v1/catalog/listings/{listingid}/publication","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindListingsBatch(client: OperationExecutor): OperationMethod<"catalog.listings.batch"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.listings.batch","method":"POST","path":"/api/v1/catalog/listings/batches","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindImportsCreate(client: OperationExecutor): OperationMethod<"catalog.imports.create"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.imports.create","method":"POST","path":"/api/v1/catalog/imports","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindImportsRead(client: OperationExecutor): OperationMethod<"catalog.imports.read"> {
  return bindOperation(client, defineContractOperation({"id":"catalog.imports.read","method":"GET","path":"/api/v1/catalog/imports/{importid}","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
