...
const ALL_OPERATION_SCHEMAS = Object.freeze({
  ...
  "identity.loginintents.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "provisioning.malls.read": Object.freeze({ input: structuralOperationInput(["mallid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "access.administrators.members.read": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "access.administrators.member.read": Object.freeze({ input: structuralOperationInput(["nodeid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "access.administrators.scopes.manage": Object.freeze({ input: structuralOperationInput(["membershipid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "access.administrators.members.note": Object.freeze({ input: structuralOperationInput(["nodeid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "member.storefront.members.read": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.detail.read": Object.freeze({ input: structuralOperationInput(["membershipid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.invitees.read": Object.freeze({ input: structuralOperationInput(["membershipid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.orders.read": Object.freeze({ input: structuralOperationInput(["membershipid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.config.read": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.config.manage": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.custom.read": Object.freeze({ input: structuralOperationInput(["membershipid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.storefront.custom.manage": Object.freeze({ input: structuralOperationInput(["membershipid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "member.malls.open": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "member.sovereignty.upgrade": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "order.orders.receive": Object.freeze({ input: structuralOperationInput(["orderid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "payment.intents.read": Object.freeze({ input: structuralOperationInput(["paymentid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  ...
  "partner.customers.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "partner.customers.update": Object.freeze({ input: structuralOperationInput(["customerid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "partner.customers.enable": Object.freeze({ input: structuralOperationInput(["customerid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "partner.customers.disable": Object.freeze({ input: structuralOperationInput(["customerid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "partner.customers.get": Object.freeze({ input: structuralOperationInput(["customerid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "partner.customers.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "partner.customeroptions.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.products.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.products.revise": Object.freeze({ input: structuralOperationInput(["productid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.products.enable": Object.freeze({ input: structuralOperationInput(["productid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.products.disable": Object.freeze({ input: structuralOperationInput(["productid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.products.get": Object.freeze({ input: structuralOperationInput(["productid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.products.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.productoptions.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentialpools.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentials.generate": Object.freeze({ input: structuralOperationInput(["poolid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentials.import": Object.freeze({ input: structuralOperationInput(["poolid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentialpools.close": Object.freeze({ input: structuralOperationInput(["poolid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentialpools.get": Object.freeze({ input: structuralOperationInput(["poolid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentialpools.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentials.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentials.get": Object.freeze({ input: structuralOperationInput(["credentialid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.credentialexports.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.jobs.get": Object.freeze({ input: structuralOperationInput(["jobid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequests.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequests.update": Object.freeze({ input: structuralOperationInput(["requestid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequests.submit": Object.freeze({ input: structuralOperationInput(["requestid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequests.cancel": Object.freeze({ input: structuralOperationInput(["requestid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequests.get": Object.freeze({ input: structuralOperationInput(["requestid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequests.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.stockrequestoptions.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.templates.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.templates.revise": Object.freeze({ input: structuralOperationInput(["templateid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.templates.enable": Object.freeze({ input: structuralOperationInput(["templateid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.templates.disable": Object.freeze({ input: structuralOperationInput(["templateid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.templates.get": Object.freeze({ input: structuralOperationInput(["templateid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.templates.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.tasks.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.tasks.approve": Object.freeze({ input: structuralOperationInput(["taskid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.tasks.reject": Object.freeze({ input: structuralOperationInput(["taskid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "approval.instances.get": Object.freeze({ input: structuralOperationInput(["instanceid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorders.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorders.update": Object.freeze({ input: structuralOperationInput(["orderid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorders.submit": Object.freeze({ input: structuralOperationInput(["orderid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorders.cancel": Object.freeze({ input: structuralOperationInput(["orderid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorders.get": Object.freeze({ input: structuralOperationInput(["orderid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorders.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issuebatches.retry": Object.freeze({ input: structuralOperationInput(["batchid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issuebatches.get": Object.freeze({ input: structuralOperationInput(["batchid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.issueorderexports.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.actionbatches.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.actionbatches.get": Object.freeze({ input: structuralOperationInput(["actionbatchid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.actionbatches.list": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.actionbatches.retry": Object.freeze({ input: structuralOperationInput(["actionbatchid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.actionexports.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.search.read": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.activations.secret": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.activations.numbersecret": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.vouchers.bind": Object.freeze({ input: structuralOperationInput(["voucherid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.vouchers.unbind": Object.freeze({ input: structuralOperationInput(["voucherid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.vouchers.get": Object.freeze({ input: structuralOperationInput(["voucherid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.vouchers.getbynumber": Object.freeze({ input: structuralOperationInput(["number"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.vouchers.timeline": Object.freeze({ input: structuralOperationInput(["voucherid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.redemptions.quote": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.tenderholds.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.tenderholds.consume": Object.freeze({ input: structuralOperationInput(["holdid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.tenderholds.release": Object.freeze({ input: structuralOperationInput(["holdid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.redemptions.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.refunds.create": Object.freeze({ input: structuralOperationInput(["redemptionid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.redemptions.get": Object.freeze({ input: structuralOperationInput(["redemptionid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.searchfacets.read": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.searchsnapshots.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.searchexports.create": Object.freeze({ input: structuralOperationInput([] as const), output: structuralOperationOutput(), fidelity: "structural" }),
  "voucher.exports.get": Object.freeze({ input: structuralOperationInput(["exportid"] as const), output: structuralOperationOutput(), fidelity: "structural" }),
});
