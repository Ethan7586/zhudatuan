...
const matrix = parse(readFileSync(resolve(root, '05_docs_ziliao/docs_wendang/requirements/mvp.yml'), 'utf8'));
const delivery = readFileSync(resolve(root, '02_platform_pingtai/infrastructure/aliyun/delivery.yml'), 'utf8');
