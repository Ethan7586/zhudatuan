...
function bindPartnersRead(client: OperationExecutor): OperationMethod<"partner.partners.read"> { return bindOperation(client, defineOperation({"id":"partner.partners.read","method":"GET","path":"/api/v1/partners","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindPartnersManage(client: OperationExecutor): OperationMethod<"partner.partners.manage"> { return bindOperation(client, defineOperation({"id":"partner.partners.manage","method":"PUT","path":"/api/v1/partners/{partnerid}","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":800})); }
