...
3. `/Users/Ethan/Desktop/zdt-next/05_docs_ziliao/docs_wendang/prompts/主打团标准商城提示词.md` 中适用于工程纪律与事实判断的规则。
...
1. 《主打团商品管理系统 56 分 → 95 分升级提示词》的永久业务基线。
