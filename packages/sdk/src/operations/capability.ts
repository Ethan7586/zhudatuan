...
export const CAPABILITY_METHOD_BY_OPERATION = Object.freeze({
  "capability.assignments.read": "assignmentsRead",
  "capability.assignments.manage": "assignmentsManage",
} as const satisfies Readonly<Record<(typeof CAPABILITY_OPERATION_IDS)[number], keyof CapabilityOperations>>);
