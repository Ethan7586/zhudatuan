...
describe('identity notification job processor', () => {
  ...
  it.each([
    ['generic notification kind', { id: 'job:1', kind: 'notification', scope_id: null, payload: { challenge }, attempts: 1, fencing_token: 1 }],
    ['dispatch payload', { id: 'job:1', kind: 'identitynotification', scope_id: null, payload: { dispatch: 'dispatch:1' }, attempts: 1, fencing_token: 1 }],
    ['mixed payload', { id: 'job:1', kind: 'identitynotification', scope_id: null, payload: { challenge, event: 'order.created' }, attempts: 1, fencing_token: 1 }],
    ['untrusted challenge id', { id: 'job:1', kind: 'identitynotification', scope_id: null, payload: { challenge: 'challenge:../../payment' }, attempts: 1, fencing_token: 1 }],
