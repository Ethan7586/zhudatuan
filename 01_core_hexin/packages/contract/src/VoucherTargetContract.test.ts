...
const matrix = readFileSync(new URL('../../../../05_docs_ziliao/docs_wendang/voucher/Operations.md', import.meta.url), 'utf8');
...
describe('voucher target contract', () => {
  ...
  it('keeps all frozen operations out of runtime controller and capability artifacts', () => {
    ...
    const capabilities = readFileSync(new URL('../../../../02_platform_pingtai/database/contracts/current.sql', import.meta.url), 'utf8');
