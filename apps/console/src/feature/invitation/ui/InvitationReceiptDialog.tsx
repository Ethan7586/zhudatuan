...
import { invitationKind, invitationTarget, invitationTime } from '../infrastructure/InvitationMapper';
import type { InvitationReceipt } from '../model/Invitation';

export function InvitationReceiptDialog({ receipt, organization, onDiscard }: Readonly<{ receipt?: InvitationReceipt; organization: string; onDiscard: () => void }>) {
