...
storefrontJourney('storefront payment journey', {
  ...
  sources: ['services/commerce/src/modules/checkout/application/service/ConfirmCheckout.ts', 'services/commerce/src/modules/payment/infrastructure/persistence/PaymentReader.ts'],
