...
const outputs = [
  ...
  'docs/requirements/currenttrace.yml',
  'docs/evidence/changeplan.json',
  'docs/evidence/retirement.json',
  'docs/requirements/mapping.json',
  'docs/当前代码业务功能清单-20260904.md',
  ...
  'apps/miniapp/miniprogram/generated/DesignBinding.ts',
  ...
  'services/commerce/src/generated/EventCatalog.ts',
  'services/commerce/src/generated/ModuleCatalog.ts',
