...
export function bindTreeRead(client: OperationExecutor): OperationMethod<"navigation.tree.read"> { return bindOperation(client, defineOperation({ ...{"id":"navigation.tree.read","method":"GET","path":"/api/v1/navigation","audience":"console","targets":["console","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":3000,"errorUnion":["ACCESS_VERSION_STALE","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","NAVIGATION_CATALOG_MISMATCH","NAVIGATION_EMPTY","NAVIGATION_SCOPE_DENIED","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("NavigationTreeReadInput", [] as const, false), output: exactOperationOutput("NavigationTreeReadOutput") })); }
