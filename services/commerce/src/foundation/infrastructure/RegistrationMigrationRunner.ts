...
const REGISTRATION_TARGET_VERSION = '20260828183000';
const REGISTRATION_TARGET_CHECKSUM = 'dea267e01bc8905433242ae5cb026948750587749c5178a59ba5d08a18e0d0b8';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260828183000_zhudatuan_runtime_readiness_repair.sql') valid`,
