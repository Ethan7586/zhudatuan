...
| 工作包 | 主要文件范围 | 依赖 | 验收 |
| --- | --- | --- | --- |
| `A01` Requirement Trace | `docs/requirements/*`、Contract definitions | 无 | 14 个 OMS ID 全链可追踪 |
...
| `B03` Order 架构门禁 | `scripts/check/*` | B01/B02 | Order SQL/根文件/Public DB 泄漏检查先独立通过 |
