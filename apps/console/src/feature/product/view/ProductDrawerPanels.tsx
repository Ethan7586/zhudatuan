...
export function ProductDrawerPanels({ tab, listing, detail, pending, error }: Readonly<{ tab: ProductDrawerTab; listing: Listing; detail: ProductDetail | undefined; pending: boolean; error?: string }>) {
  if (pending)
    return (
