...
const REGISTRATION_TARGET_VERSION = '20260902137000';
const REGISTRATION_TARGET_CHECKSUM = 'e2de98bbb02b89ae2a017bb83295c3dc24ffb74dc9dcdf76891ed587d6b4ed5e';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260902137000_separate_login_account_from_mobile.sql') valid`,
