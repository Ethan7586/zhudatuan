...
export const CAPABILITY_CODES_BY_OWNER = Object.freeze({
  ...
  "catalog": Object.freeze(["catalog.pools.read","catalog.categories.read","catalog.categories.create","catalog.pools.attach","catalog.pools.detach","catalog.pools.allocate","catalog.listings.price.set","catalog.listings.pool.set","catalog.product.detail.read","catalog.mediauploads.create","catalog.products.create","catalog.products.update","catalog.products.archive","catalog.listings.read","catalog.facets.read","catalog.listings.publish","catalog.listings.unpublish","catalog.listings.batch","catalog.imports.create","catalog.imports.read"] as const),
