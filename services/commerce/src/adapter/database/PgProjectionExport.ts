...
export async function requestProjectionExport(request: OperationRequest, database: SqlExecutor, report: ProjectionExportReport,
  filter: Readonly<Record<string, unknown>>, visibleFilter: Readonly<Record<string, unknown>> = filter) {
