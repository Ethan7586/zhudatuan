...
const REGISTRATION_TARGET_VERSION = '20260903110000';
const REGISTRATION_TARGET_CHECKSUM = '6e08b67bcf8d7c496c7675ff38cb301da6ed0677fa30ecca4adeb80f5d6de889';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260903110000_zhudatuan_payment_webhook_access.sql') valid`,
