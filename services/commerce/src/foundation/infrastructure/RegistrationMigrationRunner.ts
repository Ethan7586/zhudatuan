...
const REGISTRATION_TARGET_VERSION = '20260830105000';
const REGISTRATION_TARGET_CHECKSUM = 'b6ee9a1f1a8591f9efdf4c8c2362b9aa32a16b3ce018321df97669a56e6fcaaf';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260830105000_business_runtime_schema_visibility.sql') valid`,
