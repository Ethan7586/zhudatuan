...
const worker = '01_core_hexin/services/commerce/src/foundation/application/JobRunner.ts';
...
export const JOB_CATALOG = Object.freeze([
  registerJob({ id: 'catalogsync', owner: 'channel', queue: 'channel', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/catalogsync.md', worker }),
  registerJob({ id: 'pricesync', owner: 'pricing', queue: 'channel', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/pricesync.md', worker }),
  registerJob({ id: 'inventorysync', owner: 'inventory', queue: 'channel', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/inventorysync.md', worker }),
  registerJob({ id: 'experiencepublish', owner: 'experience', queue: 'experience', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/experiencepublish.md', worker }),
  registerJob({ id: 'statementsync', owner: 'channel', queue: 'channel', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/statementsync.md', worker }),
  registerJob({ id: 'channelwebhook', owner: 'channel', queue: 'channel', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/channelwebhook.md', worker }),
  registerJob({ id: 'orderexpiry', owner: 'order', queue: 'transaction', concurrency: 16, timeout: 15_000, retry, lease: 30, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/orderexpiry.md', worker }),
  registerJob({ id: 'paymentquery', owner: 'payment', queue: 'payment', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/paymentquery.md', worker }),
  registerJob({ id: 'paymentrefund', owner: 'payment', queue: 'payment', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/paymentrefund.md', worker }),
  registerJob({ id: 'fulfillment', owner: 'fulfillment', queue: 'fulfillment', concurrency: 16, timeout: 45_000, retry, lease: 90, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/fulfillment.md', worker }),
  registerJob({ id: 'tracking', owner: 'fulfillment', queue: 'fulfillment', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/tracking.md', worker }),
  registerJob({ id: 'benefitgrant', owner: 'benefit', queue: 'benefit', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/benefitgrant.md', worker }),
  registerJob({ id: 'benefitexpiry', owner: 'benefit', queue: 'benefit', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/benefitexpiry.md', worker }),
  registerJob({ id: 'voucherissue', owner: 'voucher', queue: 'benefit', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/voucherissue.md', worker }),
  ...
  registerJob({ id: 'projection', owner: 'reporting', queue: 'projection', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/projection.md', worker }),
  registerJob({ id: 'export', owner: 'reporting', queue: 'export', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/export.md', worker }),
  registerJob({ id: 'riskscan', owner: 'risk', queue: 'risk', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/riskscan.md', worker }),
  registerJob({ id: 'cleanup', owner: 'runtime', queue: 'maintenance', concurrency: 2, timeout: 60_000, retry, lease: 90, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/cleanup.md', worker }),
  registerJob({ id: 'memberimport', owner: 'member', queue: 'import', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/memberimport.md', worker }),
  registerJob({ id: 'catalogimport', owner: 'catalog', queue: 'import', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/catalogimport.md', worker }),
  registerJob({ id: 'inventoryimport', owner: 'inventory', queue: 'import', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/inventoryimport.md', worker }),
  registerJob({ id: 'voucherimport', owner: 'voucher', queue: 'import', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/voucherimport.md', worker }),
  registerJob({ id: 'supportsla', owner: 'support', queue: 'support', concurrency: 8, timeout: 15_000, retry, lease: 30, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/supportsla.md', worker }),
  registerJob({ id: 'supportscan', owner: 'support', queue: 'support', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/supportscan.md', worker }),
  registerJob({ id: 'auditarchive', owner: 'audit', queue: 'maintenance', concurrency: 2, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/auditarchive.md', worker }),
  registerJob({ id: 'extensionhealth', owner: 'extension', queue: 'maintenance', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: '05_docs_ziliao/docs_wendang/operations/extensionhealth.md', worker }),
