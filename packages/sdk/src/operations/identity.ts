...
export interface IdentityOperations {
  ...
  readonly handoversRead: OperationMethod<"identity.handovers.read">;
  readonly handoversCreate: OperationMethod<"identity.handovers.create">;
...
export const IDENTITY_METHOD_BY_OPERATION = Object.freeze({
  ...
  "identity.handovers.read": "handoversRead",
  "identity.handovers.create": "handoversCreate",
...
export function createIdentityOperations(client: OperationExecutor): IdentityOperations { return Object.freeze({
    ...
    handoversRead: bindHandoversRead(client),
    handoversCreate: bindHandoversCreate(client),
...
export function bindSessionDelete(client: OperationExecutor): OperationMethod<"identity.session.delete"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.session.delete","method":"DELETE","path":"/api/v1/identity/session","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"required","idempotent":true,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RESOURCE_NOT_FOUND","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.session.delete") })); }

export function createFetchIdentityHandoversRead(baseUrl: string): OperationMethod<"identity.handovers.read"> { return bindHandoversRead(new ApiClient(baseUrl, new FetchTransport())); }

export function bindHandoversRead(client: OperationExecutor): OperationMethod<"identity.handovers.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.handovers.read","method":"GET","path":"/api/v1/identity/handovers","audience":"console","targets":["console","store"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.handovers.read") })); }

export function createFetchIdentityHandoversCreate(baseUrl: string): OperationMethod<"identity.handovers.create"> { return bindHandoversCreate(new ApiClient(baseUrl, new FetchTransport())); }

export function bindHandoversCreate(client: OperationExecutor): OperationMethod<"identity.handovers.create"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.handovers.create","method":"POST","path":"/api/v1/identity/handovers","audience":"console","targets":["console","store"],"responseMode":"json","idempotencyPolicy":"required","idempotent":true,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RESOURCE_NOT_FOUND","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.handovers.create") })); }
...
export function bindMembershipsRead(client: OperationExecutor): OperationMethod<"identity.memberships.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.memberships.read","method":"GET","path":"/api/v1/identity/memberships","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","MEMBERSHIP_SELECTION_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.memberships.read") })); }
...
export function bindInvitationsRead(client: OperationExecutor): OperationMethod<"identity.invitations.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.invitations.read","method":"GET","path":"/api/v1/identity/invitations","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.invitations.read") })); }
...
export function bindBootstrapRead(client: OperationExecutor): OperationMethod<"identity.bootstrap.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.bootstrap.read","method":"GET","path":"/api/v1/identity/bootstrap","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":300,"errorUnion":["AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","RATE_LIMITED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.bootstrap.read") })); }
...
export function bindProvidersRead(client: OperationExecutor): OperationMethod<"identity.providers.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.providers.read","method":"GET","path":"/api/v1/identity/providers","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":300,"errorUnion":["AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","IDENTITY_PROVIDER_CONFIGURATION_INVALID","INTERNAL_ERROR","RATE_LIMITED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.providers.read") })); }
...
export function bindLinksRead(client: OperationExecutor): OperationMethod<"identity.links.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.links.read","method":"GET","path":"/api/v1/identity/links","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":300,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.links.read") })); }
