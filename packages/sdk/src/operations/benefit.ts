...
import { BENEFIT_QUERY_SCHEMAS, BENEFIT_BODY_SCHEMAS, BENEFIT_OUTPUT_SCHEMAS } from '@shop/contract/schema/Benefit';
...
export function bindLedgersRead(client: OperationExecutor): OperationMethod<"benefit.ledgers.read"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.ledgers.read","method":"GET","path":"/api/v1/benefits/ledgers","audience":"storefront","targets":["storefront","miniapp"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_QUERY_SCHEMAS.BenefitLedgersReadInput, [] as const, false), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitLedgersReadOutput) })); }
...
export function bindPlansRead(client: OperationExecutor): OperationMethod<"benefit.plans.read"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.plans.read","method":"GET","path":"/api/v1/benefits/plans","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_QUERY_SCHEMAS.BenefitPlansReadInput, [] as const, false), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitPlansReadOutput) })); }
...
export function bindPlansManage(client: OperationExecutor): OperationMethod<"benefit.plans.manage"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.plans.manage","method":"PUT","path":"/api/v1/benefits/plans/{planid}","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":true,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(BENEFIT_BODY_SCHEMAS.BenefitPlansManageInput, ["planid"] as const, true), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitPlansManageOutput) })); }
...
export function bindBudgetsRead(client: OperationExecutor): OperationMethod<"benefit.budgets.read"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.budgets.read","method":"GET","path":"/api/v1/benefits/budgets","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_QUERY_SCHEMAS.BenefitBudgetsReadInput, [] as const, false), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitBudgetsReadOutput) })); }
...
export function bindGrantsDecide(client: OperationExecutor): OperationMethod<"benefit.grants.decide"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.grants.decide","method":"PUT","path":"/api/v1/benefits/grants/{batchid}/decision","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":true,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(BENEFIT_BODY_SCHEMAS.BenefitGrantsDecideInput, ["batchid"] as const, true), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitGrantsDecideOutput) })); }
...
export function bindGrantsRead(client: OperationExecutor): OperationMethod<"benefit.grants.read"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.grants.read","method":"GET","path":"/api/v1/benefits/grants","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_QUERY_SCHEMAS.BenefitGrantsReadInput, [] as const, false), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitGrantsReadOutput) })); }
...
export function bindGrantsControl(client: OperationExecutor): OperationMethod<"benefit.grants.control"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.grants.control","method":"POST","path":"/api/v1/benefits/grants/{batchid}/control","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_BODY_SCHEMAS.BenefitGrantsControlInput, ["batchid"] as const, true), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitGrantsControlOutput) })); }
...
export function bindGrantsRevoke(client: OperationExecutor): OperationMethod<"benefit.grants.revoke"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.grants.revoke","method":"POST","path":"/api/v1/benefits/grants/{batchid}/revoke","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_BODY_SCHEMAS.BenefitGrantsRevokeInput, ["batchid"] as const, true), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitGrantsRevokeOutput) })); }
...
export function bindLotsRead(client: OperationExecutor): OperationMethod<"benefit.lots.read"> { return bindOperation(client, defineOperation({ ...{"id":"benefit.lots.read","method":"GET","path":"/api/v1/benefits/lots","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","BENEFIT_BALANCE_INSUFFICIENT","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(BENEFIT_QUERY_SCHEMAS.BenefitLotsReadInput, [] as const, false), output: exactOperationOutputFrom(BENEFIT_OUTPUT_SCHEMAS.BenefitLotsReadOutput) })); }
