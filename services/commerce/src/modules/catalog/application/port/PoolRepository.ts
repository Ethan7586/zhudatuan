...
export interface PoolRepository {
  ...
  attach(context: WriteTransactionContext, accessScope: string, mall: string, pool: string): Promise<Readonly<Record<string, unknown>> | null>;
  detach(context: WriteTransactionContext, accessScope: string, mall: string, pool: string): Promise<Readonly<Record<string, unknown>> | null>;
