...
function bindSessionsComplete(client: OperationExecutor): OperationMethod<"identity.sessions.complete"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.sessions.complete","method":"POST","path":"/api/v1/identity/sessions/complete","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":false,"timeout":800,"errorUnion":["AUTHORIZATION_DENIED","CHALLENGE_INVALID","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","IDEMPOTENCY_REPLAY_FORBIDDEN","INTERNAL_ERROR","INVITATION_INVALID","ORIGIN_REQUIRED","PREAUTH_EXPIRED","PREAUTH_REQUIRED","PROOF_REQUIRED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RISK_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.sessions.complete") })); }
...
function bindSessionRead(client: OperationExecutor): OperationMethod<"identity.session.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.session.read","method":"GET","path":"/api/v1/identity/session","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","RESOURCE_NOT_FOUND","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.session.read") })); }
...
function bindMembershipsRead(client: OperationExecutor): OperationMethod<"identity.memberships.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.memberships.read","method":"GET","path":"/api/v1/identity/memberships","audience":"storefront","targets":["storefront"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","MEMBERSHIP_SELECTION_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.memberships.read") })); }
...
function bindChallengesCreate(client: OperationExecutor): OperationMethod<"identity.challenges.create"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.challenges.create","method":"POST","path":"/api/v1/identity/challenges","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":false,"timeout":800,"errorUnion":["AUTHORIZATION_DENIED","CHALLENGE_PURPOSE_INVALID","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_REQUIRED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RISK_DENIED","RISK_REVIEW_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.challenges.create") })); }
...
function bindInvitationsResolve(client: OperationExecutor): OperationMethod<"identity.invitations.resolve"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.invitations.resolve","method":"POST","path":"/api/v1/identity/invitations/resolve","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":false,"timeout":800,"errorUnion":["AUTHORIZATION_DENIED","AUTH_TICKET_EXCHANGE_REJECTED","CHALLENGE_INVALID","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","INVITATION_INVALID","ORIGIN_REQUIRED","PREAUTH_EXPIRED","PREAUTH_REQUIRED","PROOF_REQUIRED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.invitations.resolve") })); }
...
function bindInvitationsRead(client: OperationExecutor): OperationMethod<"identity.invitations.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.invitations.read","method":"GET","path":"/api/v1/identity/invitations","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.invitations.read") })); }
...
function bindEnrollmentsRead(client: OperationExecutor): OperationMethod<"identity.enrollments.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.enrollments.read","method":"GET","path":"/api/v1/identity/enrollments/{id}","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","INVITATION_INVALID","PREAUTH_EXPIRED","PREAUTH_REQUIRED","RATE_LIMITED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.enrollments.read") })); }
...
function bindMembersManage(client: OperationExecutor): OperationMethod<"identity.members.manage"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.members.manage","method":"PUT","path":"/api/v1/identity/members/{membershipid}","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, ...identityClientSchema("identity.members.manage") })); }
...
function bindBootstrapRead(client: OperationExecutor): OperationMethod<"identity.bootstrap.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.bootstrap.read","method":"GET","path":"/api/v1/identity/bootstrap","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":300,"errorUnion":["AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","RATE_LIMITED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.bootstrap.read") })); }
...
function bindProvidersRead(client: OperationExecutor): OperationMethod<"identity.providers.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.providers.read","method":"GET","path":"/api/v1/identity/providers","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":300,"errorUnion":["AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","IDENTITY_PROVIDER_CONFIGURATION_INVALID","INTERNAL_ERROR","RATE_LIMITED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.providers.read") })); }
...
function bindLinksRead(client: OperationExecutor): OperationMethod<"identity.links.read"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.links.read","method":"GET","path":"/api/v1/identity/links","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":300,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.links.read") })); }
...
function bindProvidersManage(client: OperationExecutor): OperationMethod<"identity.providers.manage"> { return bindOperation(client, defineScopedOperation({ ...{"id":"identity.providers.manage","method":"PUT","path":"/api/v1/identity/providers/{providerid}","audience":"console","targets":["console"],"responseMode":"json","idempotent":false,"timeout":1000,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","IDENTITY_PROVIDER_CONFIGURATION_INVALID","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, ...identityClientSchema("identity.providers.manage") })); }
