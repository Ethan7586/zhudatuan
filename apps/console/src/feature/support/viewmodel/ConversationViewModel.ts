...
export function useConversationViewModel(context: ConsoleContext, ticketId: string | undefined, ticket: Ticket | undefined, dependencies: SupportDependencies, refreshQueue: () => Promise<unknown>, attachmentAllowed: boolean) {
