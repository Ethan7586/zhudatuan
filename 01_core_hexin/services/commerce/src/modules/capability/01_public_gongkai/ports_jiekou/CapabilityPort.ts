...
export class CapabilityPort {
  save(database: OperationDatabase, input: EntitlementInput) {
    return database.query(`insert into capability.entitlement(id,scope_id,capability_id,state,quota,effective_at,expires_at,version)
...
export const capabilityPort = new CapabilityPort();
