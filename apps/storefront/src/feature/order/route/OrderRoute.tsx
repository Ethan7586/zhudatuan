...
export function Component() {
  ...
  const invoices = useInvoiceViewModel();
  return search.get('view') === 'invoices' ? (
    <div className="sw-web-container mx-auto max-w-[1240px] p-4">
      <InvoicePanel viewmodel={invoices} />
    </div>
  ) : (
    <OrderPage viewmodel={orders} />
  );
}
