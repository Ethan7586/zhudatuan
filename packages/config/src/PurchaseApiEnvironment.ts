...
const CONFIGURATION_KEY = /^(?:API_|APP_ENV$|AUTH_|DATABASE_|EXTENSION_|IDENTITY_|INVOICE_|JOB_|KMS_|NOTIFICATION_|OBJECT_|PAYMENT_|PAYOUT_|PII_|PUBLIC_|PURCHASE_|QUOTE_|REDIS_|SECRET_|SESSION_|SERVICE_VERSION$|WEB_BUSINESS_|WECHAT_)/;
...
export function validatePurchaseApiEnvironment(source: EnvironmentSource): void {
  ...
  bearerToken(source.KMS_BEARER_TOKEN, 'KMS_BEARER_TOKEN_INVALID');
