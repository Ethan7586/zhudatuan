...
export interface OrganizationOperations {
  ...
  readonly mallsCreate: OperationMethod<"organization.malls.create">;
  readonly mallsRead: OperationMethod<"organization.malls.read">;
  readonly mallsUpdate: OperationMethod<"organization.malls.update">;
...
export const ORGANIZATION_METHOD_BY_OPERATION = Object.freeze({
  "organization.layers.read": "layersRead",
  "organization.malls.create": "mallsCreate",
  "organization.malls.read": "mallsRead",
  "organization.malls.update": "mallsUpdate",
  "organization.stores.read": "storesRead",
  "organization.stores.manage": "storesManage",
  "organization.directories.read": "directoriesRead",
  "organization.directories.manage": "directoriesManage",
  "organization.directories.sync": "directoriesSync",
  "organization.directories.syncruns.read": "directoriesSyncrunsRead",
  "organization.directoryevents.receive": "directoryeventsReceive",
} as const satisfies Readonly<Record<(typeof ORGANIZATION_OPERATION_IDS)[number], keyof OrganizationOperations>>);
...
export function createOrganizationOperations(client: OperationExecutor): OrganizationOperations { return Object.freeze({
    ...
    mallsUpdate: bindMallsUpdate(client),
...
export function bindLayersRead(client: OperationExecutor): OperationMethod<"organization.layers.read"> { return bindOperation(client, defineOperation({ ...{"id":"organization.layers.read","method":"GET","path":"/api/v1/organizations/layers","audience":"console","targets":["console","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("OrganizationLayersReadInput", [] as const, false), output: exactOperationOutput("OrganizationLayersReadOutput") })); }

export function createFetchOrganizationMallsCreate(baseUrl: string): OperationMethod<"organization.malls.create"> { return bindMallsCreate(new ApiClient(baseUrl, new FetchTransport())); }

export function bindMallsCreate(client: OperationExecutor): OperationMethod<"organization.malls.create"> { return bindOperation(client, defineOperation({ ...{"id":"organization.malls.create","method":"POST","path":"/api/v1/organization/malls","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":1000,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RESOURCE_NOT_FOUND","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInput("OrganizationMallsCreateInput", [] as const, true), output: exactOperationOutput("OrganizationMallsCreateOutput") })); }

export function createFetchOrganizationMallsRead(baseUrl: string): OperationMethod<"organization.malls.read"> { return bindMallsRead(new ApiClient(baseUrl, new FetchTransport())); }

export function bindMallsRead(client: OperationExecutor): OperationMethod<"organization.malls.read"> { return bindOperation(client, defineOperation({ ...{"id":"organization.malls.read","method":"GET","path":"/api/v1/organization/malls/{mallid}","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","RESOURCE_NOT_FOUND","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("OrganizationMallsReadInput", ["mallid"] as const, false), output: exactOperationOutput("OrganizationMallsReadOutput") })); }

export function createFetchOrganizationMallsUpdate(baseUrl: string): OperationMethod<"organization.malls.update"> { return bindMallsUpdate(new ApiClient(baseUrl, new FetchTransport())); }

export function bindMallsUpdate(client: OperationExecutor): OperationMethod<"organization.malls.update"> { return bindOperation(client, defineOperation({ ...{"id":"organization.malls.update","method":"PUT","path":"/api/v1/organization/malls/{mallid}","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":1000,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RESOURCE_NOT_FOUND","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInput("OrganizationMallsUpdateInput", ["mallid"] as const, true), output: exactOperationOutput("OrganizationMallsUpdateOutput") })); }
...
export function bindStoresRead(client: OperationExecutor): OperationMethod<"organization.stores.read"> { return bindOperation(client, defineOperation({ ...{"id":"organization.stores.read","method":"GET","path":"/api/v1/organizations/stores","audience":"console","targets":["console","store"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("OrganizationStoresReadInput", [] as const, false), output: exactOperationOutput("OrganizationStoresReadOutput") })); }
...
export function bindDirectoriesRead(client: OperationExecutor): OperationMethod<"organization.directories.read"> { return bindOperation(client, defineOperation({ ...{"id":"organization.directories.read","method":"GET","path":"/api/v1/organization/directories","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("OrganizationDirectoriesReadInput", [] as const, false), output: exactOperationOutput("OrganizationDirectoriesReadOutput") })); }
