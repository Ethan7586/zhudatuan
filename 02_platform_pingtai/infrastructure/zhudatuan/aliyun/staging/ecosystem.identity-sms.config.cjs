  ...
  apps: [
    {
      ...
      args: isolatedNode(
        ...
        apiEnvironmentFile,
        '01_core_hexin/services/commerce/dist/IdentityRegistrationApiMain.js'
      ),
      kill_timeout: 45_000,
    ...
    },
    {
      ...
      args: isolatedNode(['APP_ENV=production', 'JOB_RUNTIME_PROFILE=identity-notification-only'], jobsEnvironmentFile, '01_core_hexin/services/commerce/dist/IdentityNotificationJobsOnlyMain.js'),
      kill_timeout: 45_000,
