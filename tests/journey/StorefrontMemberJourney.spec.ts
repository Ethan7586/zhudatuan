...
storefrontJourney('storefront member journey', {
  ...
  routes: ['/profile'],
  sources: [
    'services/commerce/src/modules/identity/application/query/ReadMemberships.ts',
    'services/commerce/src/modules/identity/application/command/SwitchMembership.ts',
