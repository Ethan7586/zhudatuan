...
export interface ProductConfiguration { readonly customer: string; readonly name: string; readonly faceMinor: number; readonly currency: string; readonly qualification: string; readonly pool: string | null; readonly startsAt: Date; readonly expiresAt: Date; readonly activation: 'automatic' | 'secret' | 'numbersecret'; readonly approvalRequired: boolean; }
