-- Forward-only replacement for the historical img.hbbtzn.com write boundary.
-- Existing rows are deliberately not rewritten until their objects are
-- verified at media.zhudatuan.com.
...
begin
  ...
  if exists (
    ...
    where jsonb_typeof(item) <> 'object'
       ...
       or coalesce(item ->> 'coverUrl', '') !~ '^https://media\.zhudatuan\.com/catalog/products/[A-Za-z0-9_-]+/[a-f0-9]{16}/cover-[0-9]{3,4}\.webp$'
  ) then
