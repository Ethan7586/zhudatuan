...
export function createFetchObservability(baseUrl: string): ObservabilityOperations {
  return createObservabilityOperations(new ApiClient(baseUrl, new FetchTransport()));
}

export function createObservabilityOperations(client: OperationExecutor): ObservabilityOperations {
...
export function createFetchObservabilityClienterrorsCreate(baseUrl: string): OperationMethod<"observability.clienterrors.create"> {
  return bindClienterrorsCreate(new ApiClient(baseUrl, new FetchTransport()));
}
...
export function createFetchObservabilityClienterrorsRead(baseUrl: string): OperationMethod<"observability.clienterrors.read"> {
  return bindClienterrorsRead(new ApiClient(baseUrl, new FetchTransport()));
}
