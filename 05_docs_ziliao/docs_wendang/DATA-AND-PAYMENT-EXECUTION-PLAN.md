...
- `05_docs_ziliao/docs_wendang/SMART-WING-MALL-MASTER-CHARTER.md` §9 交易与支付、§16 安全与隐私
- `05_docs_ziliao/docs_wendang/mobile/WING-CODE-WECHAT-MINIAPP-MASTER-PLAN.md` §5 微信身份绑定、§8 组合支付
- `apps/wechat-miniapp/00-新任务从这里开始/10-小程序开发完全说明.md`
- `05_docs_ziliao/docs_wendang/VI-CONVERGENCE-EXECUTION-PLAN.md` 第 2 节禁止事项同样适用
