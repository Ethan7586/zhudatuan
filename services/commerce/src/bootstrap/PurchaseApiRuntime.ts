...
export const PURCHASE_SCHEMA_VERSION = '20260828180000' as const;
export const PURCHASE_SCHEMA_CHECKSUM = '0d3eb3e766c32ea0dada6a982bb07a1e797f0b3a08d8104235f2894f3721d81c' as const;
...
export async function purchaseRuntimeCompatibility(pool: DatabasePool): Promise<Readonly<CompatibilityRow>> {
  const result = await pool.query<CompatibilityRow>(`select current_user,session_user,
    ...
    array_position(array[
      ...
      to_regclass('payment.capture'),to_regclass('payment.allocation'),
