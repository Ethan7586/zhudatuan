export type ShellIconName = 'applications' | 'bell' | 'building' | 'channel' | 'chevron' | 'collapse' | 'control' | 'finance' | 'menu' | 'members' | 'orders' | 'products' | 'search' | 'system' | 'tasks' | 'trend' | 'voucher';
