...
import { REFERRAL_QUERY_SCHEMAS, REFERRAL_BODY_SCHEMAS, REFERRAL_OUTPUT_SCHEMAS } from '@shop/contract/schema/Referral';
...
export function bindSettingsRead(client: OperationExecutor): OperationMethod<"referral.settings.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.settings.read","method":"GET","path":"/api/v1/referral/settings","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralSettingsReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralSettingsReadOutput) })); }
...
export function bindSettingsManage(client: OperationExecutor): OperationMethod<"referral.settings.manage"> { return bindOperation(client, defineOperation({ ...{"id":"referral.settings.manage","method":"PUT","path":"/api/v1/referral/settings/{settingid}","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REFERRAL_NOT_ELIGIBLE","REFERRAL_PRODUCT_DISABLED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(REFERRAL_BODY_SCHEMAS.ReferralSettingsManageInput, ["settingid"] as const, true), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralSettingsManageOutput) })); }
...
export function bindProductsRead(client: OperationExecutor): OperationMethod<"referral.products.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.products.read","method":"GET","path":"/api/v1/referral/products","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralProductsReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralProductsReadOutput) })); }
...
export function bindProductsManage(client: OperationExecutor): OperationMethod<"referral.products.manage"> { return bindOperation(client, defineOperation({ ...{"id":"referral.products.manage","method":"PUT","path":"/api/v1/referral/products/{productid}","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REFERRAL_NOT_ELIGIBLE","REFERRAL_PRODUCT_DISABLED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(REFERRAL_BODY_SCHEMAS.ReferralProductsManageInput, ["productid"] as const, true), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralProductsManageOutput) })); }
...
export function bindMembersRead(client: OperationExecutor): OperationMethod<"referral.members.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.members.read","method":"GET","path":"/api/v1/referral/members","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralMembersReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralMembersReadOutput) })); }
...
export function bindMembersApprove(client: OperationExecutor): OperationMethod<"referral.members.approve"> { return bindOperation(client, defineOperation({ ...{"id":"referral.members.approve","method":"POST","path":"/api/v1/referral/members/{memberid}/approvals","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REFERRAL_NOT_ELIGIBLE","REFERRAL_PRODUCT_DISABLED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(REFERRAL_BODY_SCHEMAS.ReferralMembersApproveInput, ["memberid"] as const, true), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralMembersApproveOutput) })); }
...
export function bindMembersDisqualify(client: OperationExecutor): OperationMethod<"referral.members.disqualify"> { return bindOperation(client, defineOperation({ ...{"id":"referral.members.disqualify","method":"POST","path":"/api/v1/referral/members/{memberid}/disqualifications","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REFERRAL_NOT_ELIGIBLE","REFERRAL_PRODUCT_DISABLED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(REFERRAL_BODY_SCHEMAS.ReferralMembersDisqualifyInput, ["memberid"] as const, true), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralMembersDisqualifyOutput) })); }
...
export function bindBindingsRead(client: OperationExecutor): OperationMethod<"referral.bindings.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.bindings.read","method":"GET","path":"/api/v1/referral/bindings","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralBindingsReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralBindingsReadOutput) })); }
...
export function bindBindingsCreate(client: OperationExecutor): OperationMethod<"referral.bindings.create"> { return bindOperation(client, defineOperation({ ...{"id":"referral.bindings.create","method":"POST","path":"/api/v1/referral/bindings","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REFERRAL_ALREADY_BOUND","REFERRAL_INVALID_TOKEN","REFERRAL_NOT_ELIGIBLE","REFERRAL_PRODUCT_DISABLED","REFERRAL_RATE_INVALID","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(REFERRAL_BODY_SCHEMAS.ReferralBindingsCreateInput, [] as const, true), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralBindingsCreateOutput) })); }
...
export function bindCommissionsRead(client: OperationExecutor): OperationMethod<"referral.commissions.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.commissions.read","method":"GET","path":"/api/v1/referral/commissions","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralCommissionsReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralCommissionsReadOutput) })); }
...
export function bindEarningsRead(client: OperationExecutor): OperationMethod<"referral.earnings.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.earnings.read","method":"GET","path":"/api/v1/referral/earnings","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralEarningsReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralEarningsReadOutput) })); }
...
export function bindLinksRead(client: OperationExecutor): OperationMethod<"referral.links.read"> { return bindOperation(client, defineOperation({ ...{"id":"referral.links.read","method":"GET","path":"/api/v1/referral/links","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(REFERRAL_QUERY_SCHEMAS.ReferralLinksReadInput, [] as const, false), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralLinksReadOutput) })); }
...
export function bindWithdrawalsCreate(client: OperationExecutor): OperationMethod<"referral.withdrawals.create"> { return bindOperation(client, defineOperation({ ...{"id":"referral.withdrawals.create","method":"POST","path":"/api/v1/referral/withdrawals","audience":"public","targets":["console","storefront","miniapp","store","supplier"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_DENIED","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REFERRAL_WITHDRAWAL_CONFLICT","REFERRAL_WITHDRAWAL_TOO_SMALL","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED","VERSION_CONFLICT"]}, input: exactOperationInputFrom(REFERRAL_BODY_SCHEMAS.ReferralWithdrawalsCreateInput, [] as const, true), output: exactOperationOutputFrom(REFERRAL_OUTPUT_SCHEMAS.ReferralWithdrawalsCreateOutput) })); }
