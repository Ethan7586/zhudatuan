...
const moduleRoot = join(root, '01_core_hexin/services/commerce/src/modules');
...
if (!/queryValues\(request\.input\.query\.sku, 100\)/.test(pricing) || !/limit 100/.test(pricing)) {
  violations.push('01_core_hexin/services/commerce/src/modules/pricing/PricingOperations.ts:BOUNDED_BATCH_PROOF_MISSING');
}
