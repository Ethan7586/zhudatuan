...
function bindSettingsRead(client: OperationExecutor): OperationMethod<"referral.settings.read"> { return bindOperation(client, defineOperation({"id":"referral.settings.read","method":"GET","path":"/api/v1/referral/settings","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindSettingsManage(client: OperationExecutor): OperationMethod<"referral.settings.manage"> { return bindOperation(client, defineOperation({"id":"referral.settings.manage","method":"PUT","path":"/api/v1/referral/settings/{settingid}","audience":"console","targets":["console"],"responseMode":"json","idempotent":false,"timeout":800})); }
...
function bindProductsRead(client: OperationExecutor): OperationMethod<"referral.products.read"> { return bindOperation(client, defineOperation({"id":"referral.products.read","method":"GET","path":"/api/v1/referral/products","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindProductsManage(client: OperationExecutor): OperationMethod<"referral.products.manage"> { return bindOperation(client, defineOperation({"id":"referral.products.manage","method":"PUT","path":"/api/v1/referral/products/{productid}","audience":"console","targets":["console"],"responseMode":"json","idempotent":false,"timeout":800})); }
...
function bindMembersRead(client: OperationExecutor): OperationMethod<"referral.members.read"> { return bindOperation(client, defineOperation({"id":"referral.members.read","method":"GET","path":"/api/v1/referral/members","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindBindingsRead(client: OperationExecutor): OperationMethod<"referral.bindings.read"> { return bindOperation(client, defineOperation({"id":"referral.bindings.read","method":"GET","path":"/api/v1/referral/bindings","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindBindingsCreate(client: OperationExecutor): OperationMethod<"referral.bindings.create"> { return bindOperation(client, defineOperation({"id":"referral.bindings.create","method":"POST","path":"/api/v1/referral/bindings","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":false,"timeout":800})); }
...
function bindCommissionsRead(client: OperationExecutor): OperationMethod<"referral.commissions.read"> { return bindOperation(client, defineOperation({"id":"referral.commissions.read","method":"GET","path":"/api/v1/referral/commissions","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindEarningsRead(client: OperationExecutor): OperationMethod<"referral.earnings.read"> { return bindOperation(client, defineOperation({"id":"referral.earnings.read","method":"GET","path":"/api/v1/referral/earnings","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindLinksRead(client: OperationExecutor): OperationMethod<"referral.links.read"> { return bindOperation(client, defineOperation({"id":"referral.links.read","method":"GET","path":"/api/v1/referral/links","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindWithdrawalsRead(client: OperationExecutor): OperationMethod<"referral.withdrawals.read"> { return bindOperation(client, defineOperation({"id":"referral.withdrawals.read","method":"GET","path":"/api/v1/referral/withdrawals","audience":"public","targets":["console","storefront"],"responseMode":"json","idempotent":true,"timeout":500})); }
