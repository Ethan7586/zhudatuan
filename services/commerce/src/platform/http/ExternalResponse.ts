import { Failure, statusFailure } from '../error/Failure';
...
export async function readExternalJson(response: Response, unavailableCode: string, invalidCode: string): Promise<unknown> {
