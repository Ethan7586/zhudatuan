...
const EXECUTABLE_MARKERS = Object.freeze({
  'zhudatuan-staging-full-postgres-proxy.service': '01_core_hexin/services/commerce/dist/PostgresTlsProxyMain.js',
  'zhudatuan-staging-full-internal-runtime.service': '01_core_hexin/services/commerce/dist/InternalRuntimeMain.js',
  'zhudatuan-staging-full-rds-init.service': 'postgres-init-registration.sh',
  'zhudatuan-staging-full-migration.service': '01_core_hexin/services/commerce/dist/MigrationMain.js',
  'zhudatuan-staging-full-owner-bootstrap.service': '01_core_hexin/services/commerce/dist/BootstrapStagingOwner.js',
  'zhudatuan-staging-full-database-retire.service': 'postgres-retire-registration-bootstrap.sql',
  'zhudatuan-staging-full-identity-api.service': '01_core_hexin/services/commerce/dist/IdentityRegistrationApiMain.js',
  'zhudatuan-staging-full-identity-notification-jobs.service': '01_core_hexin/services/commerce/dist/IdentityNotificationJobsOnlyMain.js',
  'zhudatuan-staging-full-jobs.service': '01_core_hexin/services/commerce/dist/JobsMain.js',
});
