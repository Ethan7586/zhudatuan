...
function fixture(): CheckoutQuote {
  ...
  return {
    ...
    selection: { cartVersion: 2, lines: [{ listingId: 'listing:one', quantity: 1, lineVersion: 0 }], addressId: null, invoiceId: null, delivery: { method: 'digital', note: null, scheduledAt: null }, voucherIds: [], benefits: [], paymentScene: 'jsapi' },
    lines: [{ listing: 'listing:one', sku: 'sku:one', product: 'product:one', productType: 'digital', category: 'category:one', title: '商品', quantity: 1, unitMinor: 100, totalMinor: 100, discountMinor: 0, payableMinor: 100, provider: null, partner: null, stockitem: 'stock:one', versions: { cartLine: 0, listing: 1, product: 1, sku: 1, price: 'price:1', stock: 1 }, accepted: true, reasons: [] }],
    subtotalMinor: 100,
    discountMinor: 0,
    shippingMinor: 0,
    taxMinor: 0,
