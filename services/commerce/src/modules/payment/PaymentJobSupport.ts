...
export async function enqueuePaymentJob(database: { query(text: string, values?: readonly unknown[]): Promise<unknown> }, kind: string, owner: string, scope: string, payload: unknown, delay: number) {
