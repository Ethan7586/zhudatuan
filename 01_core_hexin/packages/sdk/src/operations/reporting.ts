...
function bindDashboardRead(client: OperationExecutor): OperationMethod<"reporting.dashboard.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.dashboard.read","method":"GET","path":"/api/v1/reports/dashboard","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindSalesRead(client: OperationExecutor): OperationMethod<"reporting.sales.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.sales.read","method":"GET","path":"/api/v1/reports/sales","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindProductsRead(client: OperationExecutor): OperationMethod<"reporting.products.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.products.read","method":"GET","path":"/api/v1/reports/products","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindMallsRead(client: OperationExecutor): OperationMethod<"reporting.malls.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.malls.read","method":"GET","path":"/api/v1/reports/malls","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindCategoriesRead(client: OperationExecutor): OperationMethod<"reporting.categories.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.categories.read","method":"GET","path":"/api/v1/reports/categories","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindChannelsRead(client: OperationExecutor): OperationMethod<"reporting.channels.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.channels.read","method":"GET","path":"/api/v1/reports/channels","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindPowderclassRead(client: OperationExecutor): OperationMethod<"reporting.powderclass.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.powderclass.read","method":"GET","path":"/api/v1/reports/powderclass","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindVoucherconsumptionRead(client: OperationExecutor): OperationMethod<"reporting.voucherconsumption.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.voucherconsumption.read","method":"GET","path":"/api/v1/reports/voucherconsumption","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindExportsCreate(client: OperationExecutor): OperationMethod<"reporting.exports.create"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.exports.create","method":"POST","path":"/api/v1/reports/exports","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindExportsRead(client: OperationExecutor): OperationMethod<"reporting.exports.read"> {
  return bindOperation(client, defineContractOperation({"id":"reporting.exports.read","method":"GET","path":"/api/v1/reports/exports/{exportid}","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
