...
describe('reporting module assembly', () => {
  ...
  it('keeps API and job resources workload-local', () => {
    ...
    expect(Manifest.workloads.jobs.dependencies).toEqual(['catalog', 'experience', 'member', 'organization', 'partner', 'runtime']);
    expect(Manifest.workloads.jobs.bindings).toEqual(['catalog', 'experience', 'member', 'organization', 'partner', 'runtime']);
