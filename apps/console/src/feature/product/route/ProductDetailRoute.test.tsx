...
function detail(section: string, unavailable: boolean) {
  ...
  return {
    ...
    listings: [{ id: 'listing:one', scope: 'mall:one', pool: 'pool:one', sku: 'sku:one', title: '办公福利礼盒', status: 'published', effectiveAt: '2026-09-01T00:00:00.000Z', expiresAt: null, createdAt: '2026-09-01T00:00:00.000Z', updatedAt: '2026-09-07T08:00:00.000Z', version: 3 }],
    media: [],
    ...
    timeline: [{ id: 'timeline:one', kind: 'productupdated', title: '商品主档已更新', occurredAt: '2026-09-07T08:00:00.000Z', reference: 'product:one' }],
    inventory: section === 'inventory' ? [{ sku: 'sku:one', scope: 'mall:one', location: 'warehouse:one', onhand: 14, safety: 2, status: 'active', version: 4 }] : [],
    prices: section === 'pricing' && !unavailable ? [{ sku: 'sku:one', scope: 'mall:one', currency: 'CNY', amountMinor: 9900, compareMinor: 12900, bookStatus: 'active', effectiveAt: '2026-09-01T00:00:00.000Z', expiresAt: null, bookVersion: 'offer:four', priceVersion: 4 }] : [],
    qualifications: section === 'qualification' ? [{ listing: 'listing:one', eligible: true, policyVersion: 4 }] : [],
    dependencies: {
