...
const cache = parse(await readFile(resolve(root, '02_platform_pingtai/config/cache.yml'), 'utf8'));
const capacity = parse(await readFile(resolve(root, '02_platform_pingtai/config/capacity.yml'), 'utf8'));
validate(cache, capacity);

const source = `// Generated from 02_platform_pingtai/config/cache.yml and 02_platform_pingtai/config/capacity.yml. Do not edit.\n`
...
await emit(resolve(root, '01_core_hexin/packages/config/src/RuntimeCatalog.generated.ts'), source);
await emit(resolve(root, '01_core_hexin/apps/miniapp/miniprogram/config/RuntimeLimits.js'),
  `// Generated from 02_platform_pingtai/config/capacity.yml. Do not edit.\nmodule.exports = Object.freeze(${JSON.stringify(capacity.runtime.http, null, 2)});\n`);
await emit(resolve(root, '01_core_hexin/apps/miniapp/miniprogram/config/CachePolicy.js'),
