...
import { inventoryStatus } from '../model/ProductSku';
import { formatMinor } from '../../../shared/format/Money';

export const QuickViewModal: React.FC = () => {
  const { quickViewProduct, setQuickViewProduct, addToCart, navigateTo, favorites, toggleFavorite } = useProductRuntime();
