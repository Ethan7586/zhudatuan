...
import { MEMBER_IMPORT_ACCESS_PORT } from '../../../access/public';
...
export function createJobs(context: ModuleContext): readonly ModuleJob[] {
  ...
  const persistence = new PgImportProcess(new PgTransactionManager(pool), context.ports.get(MEMBER_IMPORT_IDENTITY_PORT), context.ports.get(MEMBER_IMPORT_ACCESS_PORT));
