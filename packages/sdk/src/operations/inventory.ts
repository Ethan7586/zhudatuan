...
function bindAvailabilityRead(client: OperationExecutor): OperationMethod<"inventory.availability.read"> {
  return bindOperation(client, defineStructuralOperation({"id":"inventory.availability.read","method":"GET","path":"/api/v1/inventory/availability","audience":"member","idempotent":true,"pathKeys":[]}));
}
...
function bindImportsCreate(client: OperationExecutor): OperationMethod<"inventory.imports.create"> {
  return bindOperation(client, defineStructuralOperation({"id":"inventory.imports.create","method":"POST","path":"/api/v1/inventory/imports","audience":"operator","idempotent":false,"pathKeys":[]}));
}
...
function bindImportsRead(client: OperationExecutor): OperationMethod<"inventory.imports.read"> {
  return bindOperation(client, defineStructuralOperation({"id":"inventory.imports.read","method":"GET","path":"/api/v1/inventory/imports","audience":"operator","idempotent":true,"pathKeys":[]}));
}
