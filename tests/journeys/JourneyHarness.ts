...
const migrationText = sourceTree('database/supabase/migrations', '.sql');
const objectContract = source('database/contracts/objects.yml');
const operationController = source('services/commerce/src/foundation/interface/OperationController.ts');
