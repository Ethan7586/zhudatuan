import { OP_ORDER_AFTERSALES_READ, OP_ORDER_ORDERS_READ } from '@shop/contract/ids';
...
export const orderDetailKey = (context: ConsoleContext, reference: string) => Object.freeze(['console', context.scope.kind, context.scope.id, context.session.accessVersion, OP_ORDER_ORDERS_READ, 'detail', reference] as const);
