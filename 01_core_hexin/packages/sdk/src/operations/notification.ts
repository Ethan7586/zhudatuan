...
function bindNotificationsRead(client: OperationExecutor): OperationMethod<"notification.notifications.read"> {
  return bindOperation(client, defineContractOperation({"id":"notification.notifications.read","method":"GET","path":"/api/v1/notifications","audience":"member","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindPreferencesRead(client: OperationExecutor): OperationMethod<"notification.preferences.read"> {
  return bindOperation(client, defineContractOperation({"id":"notification.preferences.read","method":"GET","path":"/api/v1/notifications/preferences","audience":"member","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindPreferencesManage(client: OperationExecutor): OperationMethod<"notification.preferences.manage"> {
  return bindOperation(client, defineContractOperation({"id":"notification.preferences.manage","method":"PUT","path":"/api/v1/notifications/preferences/{channel}/{eventtype}","audience":"member","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindEndpointsManage(client: OperationExecutor): OperationMethod<"notification.endpoints.manage"> {
  return bindOperation(client, defineContractOperation({"id":"notification.endpoints.manage","method":"PUT","path":"/api/v1/notifications/endpoints/{channel}","audience":"member","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindTemplatesManage(client: OperationExecutor): OperationMethod<"notification.templates.manage"> {
  return bindOperation(client, defineContractOperation({"id":"notification.templates.manage","method":"PUT","path":"/api/v1/notifications/templates/{templateid}","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindTemplatesRead(client: OperationExecutor): OperationMethod<"notification.templates.read"> {
  return bindOperation(client, defineContractOperation({"id":"notification.templates.read","method":"GET","path":"/api/v1/notifications/templates","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindAnnouncementsRead(client: OperationExecutor): OperationMethod<"notification.announcements.read"> {
  return bindOperation(client, defineContractOperation({"id":"notification.announcements.read","method":"GET","path":"/api/v1/notifications/announcements","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}
...
function bindAnnouncementsManage(client: OperationExecutor): OperationMethod<"notification.announcements.manage"> {
  return bindOperation(client, defineContractOperation({"id":"notification.announcements.manage","method":"PUT","path":"/api/v1/notifications/announcements/{announcementid}","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
