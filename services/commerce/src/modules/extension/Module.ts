...
import { MANIFEST_VERIFIER } from '../../composition/SignatureVerifier';
  ...
  ports: (context) => [
    {
      ...
      value: extensionRegistryAdapter(context.service(EXTENSION_REGISTRY), new PgExtensionRepository(new PgTransactionAccess()), context.service(MANIFEST_VERIFIER), context.service(EXTENSION_LOADER)),
    },
  ],
});
