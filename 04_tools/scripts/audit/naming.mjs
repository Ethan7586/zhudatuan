...
const EXEMPT_PREFIXES = [
  '01_core_hexin/apps/miniapp/miniprogram/custom-tab-bar/', // WeChat requires this exact directory name.
  '04_tools/scripts/', // scripts and audit code are explicitly exempt
  '02_platform_pingtai/config/', // operator-owned configuration follows YAML/vendor naming conventions
  '02_platform_pingtai/database/', // SQL migrations keep timestamp_snake naming
  '05_docs_ziliao/docs_wendang/', // requirement and decision documents
  '02_platform_pingtai/infrastructure/', // vendor-mandated deployment file names
  '.github/',
  '.vercel/',
  'node_modules/',
  '01_core_hexin/packages/design/storybook-static/', // generated Storybook delivery artifact
