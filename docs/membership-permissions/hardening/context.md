...
| E003     | `database/migrations/20260809093000_membership_authorization_foundation.sql`  | Five original scope kinds, validation triggers, membership `authz_version`.               |
| E004     | `database/migrations/20260812160000_membership_permission_command_center.sql` | Reserved scope kinds, flat delegation checks and incomplete role-permission invalidation. |
