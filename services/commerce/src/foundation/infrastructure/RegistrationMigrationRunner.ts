...
const REGISTRATION_TARGET_VERSION = '20260829040000';
const REGISTRATION_TARGET_CHECKSUM = '77166f2dd111907cdf0910060362a3144e86a0606c884a3d77c8134b0743173a';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260829040000_zhudatuan_registration_bootstrap_runtime_repair.sql') valid`,
