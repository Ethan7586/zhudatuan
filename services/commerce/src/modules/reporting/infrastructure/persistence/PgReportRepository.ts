...
import type { CockpitProduct, CockpitSummary, MetricQuery, MetricRow, ReportPeriod } from '../../domain/model/Metric';
...
export class PgReportRepository implements ReportRepository {
  ...
  async cockpit(context: ReadTransactionContext, scope: string, period: ReportPeriod, application: string | null): Promise<CockpitSummary> {
    ...
    >('select reporting.cockpit($1,$2,$3) summary,reporting.cockpitproducts($1,$2,$3) products', [scope, period, application]);
