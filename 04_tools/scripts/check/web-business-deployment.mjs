...
const [caddy, deliverySource, service, environment, buildSource, operationsSource, baselineMigrationSource,
  ...
  read('02_platform_pingtai/infrastructure/zhudatuan/aliyun/systemd/zhudatuan-web-api.service'),
  read('02_platform_pingtai/infrastructure/zhudatuan/aliyun/web-business-api.env.example'),
  read('04_tools/scripts/build-commerce.mjs'),
  read('01_core_hexin/packages/contract/definitions/operations.yml'),
  read('02_platform_pingtai/database/supabase/migrations/20260828173000_zhudatuan_web_business_access.sql'),
  read('02_platform_pingtai/database/supabase/migrations/20260828180000_zhudatuan_purchase_access.sql'),
  read('01_core_hexin/services/commerce/src/bootstrap/WebBusinessApiRuntime.ts'),
  read('04_tools/tools/seed/src/SandboxCatalogBootstrapPlan.ts'),
]);
...
if (
  route?.artifact !== '01_core_hexin/services/commerce/dist/WebBusinessApiMain.js' ||
  route?.readinessArtifact !== '01_core_hexin/services/commerce/dist/WebBusinessApiReadyMain.js' ||
...
for (const token of [
  'ConditionPathExists=/opt/zhudatuan/current/01_core_hexin/services/commerce/dist/WebBusinessApiMain.js',
  'ConditionPathExists=/opt/zhudatuan/current/01_core_hexin/services/commerce/dist/WebBusinessApiReadyMain.js',
  ...
  'ExecStart=/usr/bin/env WEB_BUSINESS_API_PROFILE=web-business-only API_PORT=4322 API_BIND_HOST=127.0.0.1 /usr/bin/node 01_core_hexin/services/commerce/dist/WebBusinessApiMain.js',
  'ExecStartPost=/usr/bin/env WEB_BUSINESS_API_PROFILE=web-business-only API_PORT=4322 API_BIND_HOST=127.0.0.1 /usr/bin/node 01_core_hexin/services/commerce/dist/WebBusinessApiReadyMain.js',
...
for (const token of ["WebBusinessApiMain: '01_core_hexin/services/commerce/src/entry/WebBusinessApiMain.ts'", "WebBusinessApiReadyMain: '01_core_hexin/services/commerce/src/entry/WebBusinessApiReadyMain.ts'"]) {
...
const closure = sourceClosure(resolve(root, '01_core_hexin/services/commerce/src/entry/WebBusinessApiMain.ts'));
...
for (const file of closure) {
  ...
  if (source.includes('01_core_hexin/services/commerce-api') || source.includes('hbbtzn.com') || /@shop\/(?:provider|wechatpayment)/.test(source)) {
