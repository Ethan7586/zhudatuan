...
export class Preference {
  constructor(
    ...
    if (!member || !DELIVERY_CHANNELS.includes(channel) || !/^[a-z][a-z0-9.]{1,127}$/.test(event) || !['unknown', 'accepted', 'rejected'].includes(authorization)) throw new Error('NOTIFICATION_PREFERENCE_INVALID');
