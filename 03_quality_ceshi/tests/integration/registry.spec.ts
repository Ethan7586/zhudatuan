...
import { COMMERCE_MODULES, BUSINESS_MODULES } from '../../../01_core_hexin/services/commerce/src/app/modules';
import { ModuleRegistry, type CommerceModule } from '../../../01_core_hexin/services/commerce/src/bootstrap/ModuleRegistry';
...
test('all thirty bounded contexts plus runtime and observability have a deterministic dependency order', async () => {
  ...
  assert.equal(new Set(loaded).size, 32);
