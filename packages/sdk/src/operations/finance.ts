...
function bindFacetsRead(client: OperationExecutor): OperationMethod<"finance.facets.read"> { return bindOperation(client, defineOperation({ ...{"id":"finance.facets.read","method":"GET","path":"/api/v1/finance/facets","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("FinanceFacetsReadInput", [] as const, false), output: exactOperationOutput("FinanceFacetsReadOutput") })); }
...
function bindAuditRead(client: OperationExecutor): OperationMethod<"finance.audit.read"> { return bindOperation(client, defineOperation({ ...{"id":"finance.audit.read","method":"GET","path":"/api/v1/finance/audit","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":1000,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","RESOURCE_NOT_FOUND","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("FinanceAuditReadInput", [] as const, false), output: exactOperationOutput("FinanceAuditReadOutput") })); }
...
function bindStatementimportsCreate(client: OperationExecutor): OperationMethod<"finance.statementimports.create"> { return bindOperation(client, defineOperation({ ...{"id":"finance.statementimports.create","method":"POST","path":"/api/v1/finance/statement-imports","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"required","idempotent":false,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","RESOURCE_NOT_FOUND","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("FinanceStatementimportsCreateInput", [] as const, true), output: exactOperationOutput("FinanceStatementimportsCreateOutput") })); }
...
function bindStatementimportsRead(client: OperationExecutor): OperationMethod<"finance.statementimports.read"> { return bindOperation(client, defineOperation({ ...{"id":"finance.statementimports.read","method":"GET","path":"/api/v1/finance/statement-imports/{importid}","audience":"console","targets":["console"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","RESOURCE_NOT_FOUND","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("FinanceStatementimportsReadInput", ["importid"] as const, false), output: exactOperationOutput("FinanceStatementimportsReadOutput") })); }
