...
import { STOREFRONT_QUERY_SCHEMAS, STOREFRONT_OUTPUT_SCHEMAS } from '@shop/contract/schema/Storefront';
...
export function bindBootstrapRead(client: OperationExecutor): OperationMethod<"storefront.bootstrap.read"> { return bindOperation(client, defineOperation({ ...{"id":"storefront.bootstrap.read","method":"GET","path":"/api/v1/storefront/bootstrap","audience":"storefront","targets":["storefront","miniapp"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","MEMBERSHIP_INACTIVE","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STOREFRONT_DISABLED","STOREFRONT_HANDLE_INVALID","STOREFRONT_MEMBERSHIP_MALL_MISMATCH","STOREFRONT_NOT_FOUND","STOREFRONT_NOT_PUBLISHED","STOREFRONT_PUBLICATION_UNAVAILABLE","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(STOREFRONT_QUERY_SCHEMAS.StorefrontBootstrapReadInput, [] as const, false), output: exactOperationOutputFrom(STOREFRONT_OUTPUT_SCHEMAS.StorefrontBootstrapReadOutput) })); }
...
export function bindCatalogRead(client: OperationExecutor): OperationMethod<"storefront.catalog.read"> { return bindOperation(client, defineOperation({ ...{"id":"storefront.catalog.read","method":"GET","path":"/api/v1/storefront/catalog","audience":"storefront","targets":["storefront","miniapp"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":800,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","MEMBERSHIP_INACTIVE","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STOREFRONT_DISABLED","STOREFRONT_HANDLE_INVALID","STOREFRONT_MEMBERSHIP_MALL_MISMATCH","STOREFRONT_NOT_FOUND","STOREFRONT_NOT_PUBLISHED","STOREFRONT_PUBLICATION_UNAVAILABLE","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(STOREFRONT_QUERY_SCHEMAS.StorefrontCatalogReadInput, [] as const, false), output: exactOperationOutputFrom(STOREFRONT_OUTPUT_SCHEMAS.StorefrontCatalogReadOutput) })); }
