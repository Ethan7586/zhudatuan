...
const REGISTRATION_TARGET_VERSION = '20260901223000';
const REGISTRATION_TARGET_CHECKSUM = 'c95f702b55319f504b809e3f34865fe2120052d9cd4e6a09b43cefed655a7bde';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260901223000_publish_mall_provisioning.sql') valid`,
