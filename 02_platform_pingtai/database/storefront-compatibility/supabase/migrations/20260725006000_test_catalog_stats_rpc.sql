...
revoke all on function public.api_test_catalog_stats() from public, anon, authenticated;
grant execute on function public.api_test_catalog_stats() to service_role;
