...
export function experienceCopyIdentity(source: Pick<Experience, 'name' | 'code' | 'publicSlug'>, nonce = Date.now()): ExperienceCopyIdentity {
  ...
  return Object.freeze({
    ...
    slug: `${source.publicSlug.slice(0, SLUG_LIMIT - slugSuffix.length)}${slugSuffix}`,
  });
}
