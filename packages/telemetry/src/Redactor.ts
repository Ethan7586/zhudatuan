const SENSITIVE_KEY = /(authorization|cookie|token|secret|password|credential|proof|cardcode|address|mobile|phone|email|privatekey|apikey|csrf|nonce|challenge|callback|invite)/i;
