...
export const JOB_CATALOG = Object.freeze([
  registerJob({ id: 'catalogsync', owner: 'catalog', queue: 'channel', concurrency: 8, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: 'docs/operations/catalogsync.md', worker }),
  ...
  registerJob({ id: 'navigation', owner: 'navigation', queue: 'navigation', concurrency: 16, timeout: 15_000, retry, lease: 30, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: 'docs/operations/navigation.md', worker }),
  registerJob({ id: 'statementsync', owner: 'finance', queue: 'channel', concurrency: 4, timeout: 120_000, retry, lease: 180, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: 'docs/operations/statementsync.md', worker }),
  ...
  registerJob({ id: 'orderexpiry', owner: 'checkout', queue: 'transaction', concurrency: 16, timeout: 15_000, retry, lease: 30, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: 'docs/operations/orderexpiry.md', worker }),
  ...
  registerJob({ id: 'referralevent', owner: 'referral', queue: 'referral', concurrency: 16, timeout: 30_000, retry, lease: 60, idempotency: 'jobid', deadLetter: 'runtime.deadletter', runbook: 'docs/operations/referralevent.md', worker }),
  registerJob({
