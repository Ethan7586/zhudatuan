...
const scanRoots = [
  ...
  '01_core_hexin/apps/auth-web/public',
  '01_core_hexin/apps/auth-web/src',
  '01_core_hexin/apps/console/index.html',
  '01_core_hexin/apps/console/public',
  '01_core_hexin/apps/console/src',
  '01_core_hexin/apps/storefront-web/app',
  '01_core_hexin/apps/storefront-web/src',
  '01_core_hexin/packages/design/src',
  '01_core_hexin/services/commerce/src',
  '01_core_hexin/services/commerce-api/src',
  '01_core_hexin/extensions/payment',
];
const textExtensions = new Set(['.css', '.html', '.json', '.mjs', '.svg', '.ts', '.tsx', '.webmanifest']);
const allowedAliasSource = '01_core_hexin/apps/storefront-web/src/domain/brand/productBrand.ts';
