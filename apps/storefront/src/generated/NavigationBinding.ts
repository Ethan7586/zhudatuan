...
export const COMPONENT_KEYS = ['account', 'aftersale', 'benefit', 'cart', 'catalog', 'checkout', 'home', 'membercode', 'notification', 'order', 'payment', 'product', 'security', 'support', 'voucher'] as const;
