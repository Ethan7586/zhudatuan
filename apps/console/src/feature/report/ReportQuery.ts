...
export const reportKey = (context: ConsoleContext, view: ReportView, period: ReportPeriod, cursor?: string) => Object.freeze([
  'console', context.scope.kind, context.scope.id, context.session.accessVersion, reportOperation(view), period, cursor ?? null, 50,
] as const);
