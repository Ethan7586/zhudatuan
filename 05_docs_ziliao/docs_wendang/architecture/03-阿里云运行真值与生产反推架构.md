...
生产源码中的 `02_platform_pingtai/config/artifacts.json` 同时声明：

- Canonical：Console、`01_core_hexin/services/commerce`、Canonical Database。
- Compatibility：Auth、Storefront、`01_core_hexin/services/commerce-api`、Compatibility Database。
