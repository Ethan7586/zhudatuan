...
describe('identity authorization transaction', () => {
  ...
  it('issues an expiring proof only for configured targets', () => {
    const targets = { console: 'https://console.example.com', storefront: 'https://storefront.example.com', store: 'https://store.example.com', supplier: 'https://supplier.example.com' } as const;
