...
do $contract$
begin
  if (select count(*) from runtime.operation)<>276 then raise exception 'CONTRACT_V5_OPERATION_CATALOG_MISMATCH'; end if;
  if (select count(*) from capability.operation)<>276 then raise exception 'CONTRACT_V5_CAPABILITY_BINDING_MISMATCH'; end if;
  ...
  if not exists(
    ...
    where artifact='commerce' and version='5.0.0' and checksum='f43f53b4befd83bf6944f60c48ec823d5ecf113ed42de69613e3ba599a0d2782'
