...
export interface CredentialValue {
  ...
  readonly issueBatch: string | null;
...
export class Credential {
  ...
  available(): Credential {
    return this.move('available', null, ['generated']);
  }
  allocate(batch: string): Credential {
    return this.move('allocated', batch, ['available']);
  }
  void(): Credential {
    return this.move('void', null, ['generated', 'available']);
  }
