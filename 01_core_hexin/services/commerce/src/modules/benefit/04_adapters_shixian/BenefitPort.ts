...
import type { BenefitChoice, BenefitFinancePort, BenefitGateway, BenefitRefund, BenefitTender } from '../01_public_gongkai/BenefitPort';
...
export class BenefitPort implements BenefitGateway {
  constructor(private readonly finance: BenefitFinancePort) {}
