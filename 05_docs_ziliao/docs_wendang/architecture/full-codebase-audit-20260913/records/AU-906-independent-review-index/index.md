...
历史累计报告 GX 52，而机械枚举有 38 个 `GX-####` ID。AU-962 从首审结论恢复了 12 个确有对象的未编号 GX（DC-0028、DC-0031、DC-0034、AU-702、AU-746、AU-760、AU-767、AU-804、AU-812、AU-820、AU-822、AU-823）；另有 2 个差额只出现于历史累计数字，尚无对象或首审位置。**这 14 个差额均不可视为已复核、不可删除或降级；尤其不得把“2”虚构为候选对象。**
