...
export class DecisionsPreviewHandler implements OperationHandler<'qualification.decisions.preview', 'read'> {
  ...
  async execute(input: OperationInputFor<'qualification.decisions.preview'>, context: HandlerContext<'qualification.decisions.preview'>): Promise<OperationReply<OperationOutputFor<'qualification.decisions.preview'>>> {
