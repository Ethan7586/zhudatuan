...
export function VoucherDialogs({ model, onClose }: Readonly<{ model: VoucherActionViewModel; onClose: () => void }>) {
  return (
    <>
      <CardLibraryDialog model={model} onClose={onClose} />
      <ProgramDialog model={model} onClose={onClose} />
      <ReserveDialog model={model} onClose={onClose} />
      <ApprovalDialog model={model} onClose={onClose} />
      <IssueDialog model={model} onClose={onClose} />
      <StatusBatchDialog model={model} onClose={onClose} />
      <BindingDialog model={model} onClose={onClose} />
      <ReversalDialog model={model} onClose={onClose} />
    </>
  );
}
