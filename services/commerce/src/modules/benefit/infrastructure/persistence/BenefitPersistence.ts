...
export function benefitPersistence(context: ModuleContext): BenefitPersistence {
  ...
  return {
    ...
    readLedger: async (request, database) => {
    ...
    readPlans: async (request, database) => {
      const access = requireAccess(request);
      const page = queryPage(request.input);
    ...
    readBudgets: async (request, database) => {
      const access = requireAccess(request);
      const page = queryPage(request.input);
      const result = await database.query(
    ...
    readGrants: async (request, database) => {
      const access = requireAccess(request);
      const page = queryPage(request.input);
      const result = await database.query(
    ...
    readLots: async (request, database) => {
      const access = requireAccess(request);
      const page = queryPage(request.input);
      const result = await database.query(
