...
storefrontJourney('storefront order journey', {
  ...
  sources: ['services/commerce/src/modules/order/infrastructure/persistence/PgOrderRepository.ts', 'apps/storefront/src/feature/order/application/ReadOrder.ts'],
