...
export class Message {
  constructor(
    ...
    if ((author === 'member' && visibility !== 'external') || (author === 'system' && (actor !== 'system' || kind !== 'system' || visibility !== 'internal')) || (author !== 'system' && kind === 'system')) throw new Error('SUPPORT_MESSAGE_AUDIENCE_INVALID');
    Object.freeze(this);
  }
}
