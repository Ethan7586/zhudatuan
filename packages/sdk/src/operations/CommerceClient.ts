...
import { createNavigationOperations, type NavigationOperations } from './navigation';
...
import { createStorefrontOperations, type StorefrontOperations } from './storefront';
...
export interface CommerceClient {
  ...
  readonly navigation: NavigationOperations;
  readonly referral: ReferralOperations;
  readonly approval: ApprovalOperations;
  readonly storefront: StorefrontOperations;
}
...
export function createCommerceClient(client: OperationExecutor): CommerceClient { return Object.freeze({
    ...
    navigation: createNavigationOperations(client),
    referral: createReferralOperations(client),
    approval: createApprovalOperations(client),
    storefront: createStorefrontOperations(client),
  }); }
