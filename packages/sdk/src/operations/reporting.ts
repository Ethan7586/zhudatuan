...
function bindSalesRead(client: OperationExecutor): OperationMethod<"reporting.sales.read"> { return bindOperation(client, defineOperation({ ...{"id":"reporting.sales.read","method":"GET","path":"/api/v1/reports/sales","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("ReportingSalesReadInput", [] as const, false), output: exactOperationOutput("ReportingSalesReadOutput") })); }
...
function bindProductsRead(client: OperationExecutor): OperationMethod<"reporting.products.read"> { return bindOperation(client, defineOperation({ ...{"id":"reporting.products.read","method":"GET","path":"/api/v1/reports/products","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("ReportingProductsReadInput", [] as const, false), output: exactOperationOutput("ReportingProductsReadOutput") })); }
...
function bindExportsRead(client: OperationExecutor): OperationMethod<"reporting.exports.read"> { return bindOperation(client, defineOperation({ ...{"id":"reporting.exports.read","method":"GET","path":"/api/v1/reports/exports/{exportid}","audience":"console","targets":["console"],"responseMode":"json","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInput("ReportingExportsReadInput", ["exportid"] as const, false), output: exactOperationOutput("ReportingExportsReadOutput") })); }
