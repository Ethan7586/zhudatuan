...
import { ReadOwnership } from '../../feature/settings/access/application/ReadOwnership';
import { ReadScopes } from '../../feature/settings/access/application/ReadScopes';
...
import { PreviewSync } from '../../feature/settings/directory/application/PreviewSync';
...
import { ResetRegistration } from '../../feature/settings/member/application/ResetRegistration';
...
import { ManageCustomer } from '../../feature/settings/partner/application/ManageCustomer';
import { ReadCustomer } from '../../feature/settings/partner/application/ReadCustomer';
import { ReadCustomers } from '../../feature/settings/partner/application/ReadCustomers';
...
import { PublishQualification } from '../../feature/settings/qualification/application/PublishQualification';
import { RevokeQualification } from '../../feature/settings/qualification/application/RevokeQualification';
import { UploadEvidence } from '../../feature/settings/qualification/application/UploadEvidence';
...
export interface AccessDependencies {
  ...
  readonly readOwnership: ReadOwnership;
  readonly readScopes: ReadScopes;
...
export interface MemberDependencies {
  ...
  readonly resetRegistration: ResetRegistration;
...
export interface PartnerDependencies {
  ...
  readonly readCustomers: ReadCustomers;
...
export interface QualificationDependencies {
  ...
  readonly publish: PublishQualification;
  readonly revoke: RevokeQualification;
  readonly upload: UploadEvidence;
  readonly createIdentity: () => string;
  readonly createReference: () => string;
  readonly createQualificationReference: () => string;
}
...
export function createSettingsDependencies(): SettingsDependencies {
  ...
  return Object.freeze({
    access: Object.freeze({
      ...
      readOwnership: new ReadOwnership(access),
      readScopes: new ReadScopes(new ScopeGateway(appConfig.apiBaseUrl)),
    ...
    directory: Object.freeze({
      ...
      preview: new PreviewSync(directory),
    ...
    member: Object.freeze({
      port: member,
      read: new ReadMembers(member),
      manage: new ManageMember(member),
      resetRegistration: new ResetRegistration(member),
      createImport: new CreateMemberImport(member),
      createIdentity: () => member.createIdentity(),
    }),
    ...
    partner: Object.freeze({
      ...
      readCustomers: new ReadCustomers(partner),
      readCustomer: new ReadCustomer(partner),
      manageCustomer: new ManageCustomer(partner),
    ...
    qualification: Object.freeze({
      ...
      publish: new PublishQualification(qualification),
      revoke: new RevokeQualification(qualification),
      upload: new UploadEvidence(qualification),
      createIdentity: () => qualification.createIdentity(),
      createReference: () => qualification.createReference(),
      createQualificationReference: () => qualification.createQualificationReference(),
    }),
    risk: Object.freeze({
      port: risk,
