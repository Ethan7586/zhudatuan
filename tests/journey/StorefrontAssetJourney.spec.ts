...
storefrontJourney('storefront member asset journey', {
  operations: ['member.addresses.read', 'member.addresses.manage', 'invoice.profiles.read', 'invoice.requests.create', 'voucher.search.read', 'voucher.vouchers.get', 'voucher.vouchers.timeline', 'benefit.accounts.read'],
