...
> 2026-08-26 拓扑裁决（优先级最高）：`zhudatuan` 是未来总商城的独立空仓；本仓库是独立分商城 `smart-wing`，不得移动、复制或嵌套进总商城。完整裁决见 `docs/operations/MallTopology.md`。
> 文档状态：目标架构基线；已与全系统根治方案3.0和逐文件执行卷同步。本文所有跨仓恢复、外层 `Shop` 融合和多 Source Root 内容仅为2026-08-25迁移调查历史，不再授权文件操作。
> 唯一需求来源：`RepositoryAuthority docs/福利商城功能清单260821.xlsx`（从本 `smart-wing` 仓库根解析），SHA-256 `78cfc3b350ced633afd6bfc951f2d2a94991780fa1d4b6d571e9f1d3df322942`
...
| Payment       | `payment.provider.submit` → `ProviderSubmitJobHandler` → `modules/payment/application/job/ProviderSubmitJobHandler.ts`<br>`payment.query` → `PaymentQueryJobHandler` → `modules/payment/application/job/PaymentQueryJobHandler.ts`<br>`payment.refund.recover` → `RefundRecoveryJobHandler` → `modules/payment/application/job/RefundRecoveryJobHandler.ts`（`action=submitOrRecover`，唯一处理Pending初次提交、Unknown先查单、Retryable受控重试）<br>`payment.webhook.replay` → `WebhookReplayJobHandler` → `modules/payment/application/job/WebhookReplayJobHandler.ts` |
...
| ------------------------------------ | -------------------------------------------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tests/config/integration.vitest.ts` | root为Shop；只包含`tests/integration/**/*.test.ts` | `tests/recovery/**`、`tests/journey/**`、`**/node_modules/**`、全部构建输出    | Node environment、isolate=true、passWithNoTests=false；30s test timeout、120s hook timeout；工作者数取生成Test Config且每Worker独立Schema/Bucket/Vhost           |
| `tests/config/recovery.vitest.ts`    | root为Shop；只包含`tests/recovery/**/*.test.ts`    | `tests/integration/**`、`tests/journey/**`、`**/node_modules/**`、全部构建输出 | Node environment、isolate=true、passWithNoTests=false、fileParallelism=false、maxWorkers=1；120s test timeout、300s hook timeout，避免故障注入和恢复操作互相污染 |

两个配置只导入`packages/config/src/generated/TestConfig.ts`与Vitest API，不读业务Secret、不启动容器、不复制Runtime Config。`tools/quality/src/runtime/InfrastructureRun.ts`是基础设施生命周期唯一实现；`Database.ts`与`Migration.ts`分别以不同runId调用它，各自up四服务、读动态端口、注入各自Test Config，并在各自finally脱敏日志、down volume/orphan、删Temp Env；Migration不得连Database已销毁的容器。Vitest配置只负责收集范围和执行预算。
...
| apps/storefront                     | apps/storefront   | 以official目录同步边界为基础，保留current only有效代码      |
| apps/auth                           | apps/auth         | 恢复Credential Discovery和服务端注册，删除模拟安全逻辑      |
...
tools/tokengen/index.ts
tools/tokengen/Generator.ts
tools/tokengen/Schema.ts
tools/tokengen/Generator.test.ts
tools/quality/bootstrap.mjs
tools/quality/src/Quality.ts
tools/quality/src/TaskCatalog.ts
tools/quality/config/archive.yml
tools/quality/config/bundles.yml
tools/quality/config/cutover.yml
tools/quality/config/naming.yml
tools/quality/src/authorization/TrustPolicy.ts
tools/quality/src/authorization/AuthorizationReceipt.ts
tools/quality/src/authorization/ObjectAuthorizationReceipt.ts
tools/quality/src/authorization/EvidenceKind.ts
tools/quality/src/authorization/EvidenceEnvelope.ts
tools/quality/src/authorization/EvidenceEnvelopeBuilder.ts
tools/quality/src/authorization/EvidenceSigner.ts
tools/quality/src/authorization/KmsEvidenceSigner.ts
tools/quality/src/authorization/CheckoutClaimIssuer.ts
tools/quality/src/authorization/EvidenceCheckoutClaimIssuer.ts
tools/quality/src/authorization/AuthorizationIssuer.ts
tools/quality/src/authorization/EvidenceAuthorizationIssuer.ts
tools/quality/src/authorization/CheckoutClaimVerifier.ts
tools/quality/src/authorization/EvidenceStore.ts
tools/quality/src/authorization/ObjectEvidenceStore.ts
tools/quality/src/authorization/RunAttestor.ts
tools/quality/src/authorization/CiRunAttestor.ts
tools/quality/src/authority/AuthorityAuthorization.ts
tools/quality/src/authority/AuthoritySnapshot.ts
tools/quality/src/authority/AuthorityCli.ts
tools/quality/src/snapshot/SnapshotAuthorization.ts
tools/quality/src/snapshot/SourceSnapshot.ts
tools/quality/src/snapshot/SnapshotCli.ts
tools/quality/src/archive/ArchiveAuthorization.ts
tools/quality/src/archive/ArchiveStore.ts
tools/quality/src/archive/ObjectArchiveStore.ts
tools/quality/src/archive/ArchiveCli.ts
tools/quality/src/cutover/CutoverAuthorization.ts
tools/quality/src/cutover/CutoverState.ts
tools/quality/src/cutover/Forward.ts
tools/quality/src/cutover/Repair.ts
tools/quality/src/cutover/PostTree.ts
tools/quality/src/cutover/CleanClone.ts
tools/quality/src/cutover/GitMetadata.ts
tools/quality/src/cutover/EphemeralArtifact.ts
tools/quality/src/cutover/CanonicalRef.ts
tools/quality/src/cutover/GitCanonicalRef.ts
tools/quality/src/cutover/CutoverSessionStore.ts
tools/quality/src/cutover/ObjectCutoverSessionStore.ts
tools/quality/src/cutover/RootActivator.ts
tools/quality/src/cutover/DeleteExecutor.ts
tools/quality/src/cutover/QuarantineFinalizer.ts
tools/quality/src/cutover/CutoverCli.ts
tools/quality/src/execution/ToolBundle.ts
tools/quality/src/execution/ToolLauncher.ts
tools/quality/src/execution/CredentialBroker.ts
tools/quality/src/execution/ProviderCredentialBroker.ts
tools/quality/src/execution/TelemetryProbe.ts
tools/quality/src/execution/ProviderTelemetryProbe.ts
tools/quality/src/execution/TrafficControl.ts
tools/quality/src/execution/ProviderTrafficControl.ts
tools/quality/src/execution/MountControl.ts
tools/quality/src/execution/ProviderMountControl.ts
tools/quality/src/execution/AuthorityMaterializationControl.ts
tools/quality/src/execution/ProviderAuthorityMaterializationControl.ts
tools/quality/src/execution/ExecutorIsolationControl.ts
tools/quality/src/execution/ProviderExecutorIsolationControl.ts
tools/quality/src/execution/DeploymentControl.ts
tools/quality/src/execution/ProviderDeploymentControl.ts
tools/quality/src/execution/MigrationControl.ts
tools/quality/src/execution/ProviderMigrationControl.ts
tools/quality/src/execution/ReleaseProbe.ts
tools/quality/src/runtime/InfrastructureRun.ts
tools/quality/src/runtime/ReleaseTopology.ts
tools/quality/src/task/Generated.ts
tools/quality/src/task/Secrets.ts
tools/quality/src/task/Format.ts
tools/quality/src/task/Naming.ts
tools/quality/src/task/LineBudget.ts
tools/quality/src/task/Architecture.ts
tools/quality/src/task/Contract.ts
tools/quality/src/task/Docs.ts
tools/quality/src/task/Typecheck.ts
tools/quality/src/task/Unit.ts
tools/quality/src/task/Database.ts
tools/quality/src/task/Component.ts
tools/quality/src/task/Journey.ts
tools/quality/src/task/Security.ts
tools/quality/src/task/Performance.ts
tools/quality/src/task/Build.ts
tools/quality/src/task/Bundle.ts
tools/quality/src/task/Sbom.ts
tools/quality/src/task/Migration.ts
tools/quality/src/task/Sign.ts
tools/quality/src/audit/Workspace.ts
tools/quality/src/audit/callgraph/Main.ts
tools/quality/src/audit/callgraph/Projects.ts
tools/quality/src/audit/callgraph/Imports.ts
tools/quality/src/audit/callgraph/Operations.ts
tools/quality/src/audit/callgraph/Events.ts
tools/quality/src/audit/callgraph/Jobs.ts
tools/quality/src/audit/callgraph/Extensions.ts
tools/quality/src/audit/callgraph/Routes.ts
tools/quality/src/audit/callgraph/Database.ts
tools/quality/src/audit/callgraph/Report.ts
tools/quality/src/audit/Duplicate.ts
tools/quality/src/audit/Naming.ts
tools/quality/src/audit/Boundary.ts
tools/quality/src/audit/Regression.ts
tools/quality/src/audit/Database.ts
tools/quality/src/audit/LineBudget.ts
tools/quality/src/audit/Delivery.ts
tools/quality/src/audit/Pzero.ts
tools/quality/src/audit/Operation.ts
tools/quality/src/audit/Event.ts
tools/quality/src/audit/Extension.ts
tools/quality/src/audit/Requirement.ts
tools/quality/src/audit/Job.ts
tools/quality/src/audit/Navigation.ts
tools/quality/src/audit/Environment.ts
tools/quality/src/audit/Bundle.ts
tools/quality/src/audit/Migration.ts
tools/quality/src/audit/Generated.ts
tools/quality/src/audit/Dependency.ts
tools/quality/src/audit/RuntimeGraph.ts
tools/quality/src/FileDisposition.ts
docs/operations/FileDisposition.yml
...
tests/integration/messaging/MessageBroker.test.ts
docs/operations/evidence/.gitignore
```
