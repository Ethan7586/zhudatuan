...
RELEASE_ROOTS="${RELEASE_ROOTS:-/opt/zhudatuan/releases:/opt/zhudatuan/storefront-releases:/opt/sfl/releases:/opt/ai-delivery/dependency-layers}"
DISCOVER_RELEASE_PATTERNS="${DISCOVER_RELEASE_PATTERNS-/opt/zhudatuan/targets/*/releases /opt/sfl/nodes/*/releases /opt/sfl/nodes/*/console/releases /opt/sfl/nodes/*/targets/*/releases /opt/ai-delivery/content/*/*/*/releases}"
POINTER_SCAN_POLICIES="${POINTER_SCAN_POLICIES:-/opt/zhudatuan,4 /opt/sfl/nodes,6 /opt/sfl/backups,3 /opt/ai-delivery/content,7}"
TRANSIENT_POLICIES="${TRANSIENT_POLICIES:-/opt/zhudatuan/incoming,2 /opt/zhudatuan/candidates,24 /opt/sfl/incoming,2 /opt/sfl/candidates,24 /opt/ai-delivery/incoming,2}"
...
ALLOWED_BASES="${ALLOWED_BASES:-/opt/zhudatuan:/opt/sfl:/opt/ai-delivery}"
