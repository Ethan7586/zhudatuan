...
```text
modules/payment_zhifu/domain/model/PaymentIntent.ts
modules/payment_zhifu/domain/model/PaymentAttempt.ts
modules/payment_zhifu/domain/model/Tender.ts
modules/payment_zhifu/domain/model/Refund.ts
modules/payment_zhifu/domain/model/RefundLeg.ts
modules/payment_zhifu/domain/model/ProviderObservation.ts
modules/payment_zhifu/domain/policy/AllocationPolicy.ts
modules/payment_zhifu/application/command/CreatePaymentIntent.ts
modules/payment_zhifu/application/handler/CreatePaymentIntentHandler.ts
modules/payment_zhifu/application/command/PreparePayment.ts
modules/payment_zhifu/application/handler/PreparePaymentHandler.ts
modules/payment_zhifu/application/command/FinalizeAttempt.ts
modules/payment_zhifu/application/handler/FinalizeAttemptHandler.ts
modules/payment_zhifu/application/command/AcceptWechatWebhook.ts
modules/payment_zhifu/application/handler/AcceptWechatWebhookHandler.ts
modules/payment_zhifu/application/command/RequestRefund.ts
modules/payment_zhifu/application/handler/RequestRefundHandler.ts
modules/payment_zhifu/application/command/FinalizeRefundLeg.ts
modules/payment_zhifu/application/handler/FinalizeRefundLegHandler.ts
modules/payment_zhifu/application/command/ResolveRecovery.ts
modules/payment_zhifu/application/handler/ResolveRecoveryHandler.ts
modules/payment_zhifu/application/query/GetPayment.ts
modules/payment_zhifu/application/port/PaymentProvider.ts
modules/payment_zhifu/public/PaymentIntentPort.ts
modules/payment_zhifu/infrastructure/persistence/PgPaymentRepository.ts
modules/payment_zhifu/interface/http/PaymentRoutes.ts
modules/payment_zhifu/interface/http/PaymentWebhook.ts
modules/payment_zhifu/application/job/PaymentQueryJobHandler.ts
modules/payment_zhifu/application/job/ProviderSubmitJobHandler.ts
modules/payment_zhifu/application/job/RefundRecoveryJobHandler.ts
modules/payment_zhifu/application/job/WebhookReplayJobHandler.ts
modules/payment_zhifu/PaymentModule.ts
```
...
| Payment | Order `OrderCancelled` E55；Order `AfterSaleApproved(returnRequired=false)` E21；Fulfillment `ReturnInspected` E50 | `modules/payment_zhifu/application/consumer/OrderCancelledInboxHandler.ts`；`AfterSaleApprovedInboxHandler.ts`；`ReturnInspectedInboxHandler.ts` | `modules/payment_zhifu/PaymentModule.ts`；`tests/message/payment/<Handler>.test.ts` | 关闭Attempt或授权Refund；`OrderPlacedInboxHandler`、补建Intent、第二`provider.submit`必须为零 |
...
| `modules/payment_zhifu/*` | Runtime Event Relay与Payment Application Job分离 | Outbox Relay归技术Catalog；业务只保留下表`payment.provider.submit/query/refund.recover/webhook.replay`四个Handler |
| `modules/paymenteffects/*` | 删除泛化Effect Job | Accounting/Fulfillment/Notification各自用生成的Inbox Handler去重，不建第二业务Job |
| `modules/paymentquery/*` | `modules/payment_zhifu/application/job/PaymentQueryJobHandler.ts` | `payment.query`；保留主动查单和最终态，按Channel Bulkhead限流 |
| `modules/paymentrefund/*` | `modules/payment_zhifu/application/job/RefundRecoveryJobHandler.ts` | `payment.refund.recover`；`RequestRefundHandler`同UoW入队，Job按`action=submitOrRecover`唯一处理Pending初次提交、Unknown先查单、Retryable受控重试，再调用`FinalizeRefundLegHandler`；旧`RefundJob`只进Continuity |
