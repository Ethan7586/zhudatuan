...
const PERMANENT = new Set([
  'IMPORT_OBJECT_INVALID', 'IMPORT_HASH_MISMATCH', 'IMPORT_FILE_EMPTY', 'CSV_ROW_LIMIT_EXCEEDED', 'CSV_QUOTE_UNTERMINATED',
  'CSV_HEADER_INVALID', 'CSV_COLUMN_COUNT_INVALID', 'CSV_COLUMNS_CHANGED', 'XLSX_ARCHIVE_INVALID', 'XLSX_ARCHIVE_ENTRY_FORBIDDEN',
  'XLSX_COMPRESSION_LIMIT_EXCEEDED', 'XLSX_WORKSHEET_COUNT_INVALID', 'XLSX_COLUMN_LIMIT_EXCEEDED', 'XLSX_ROW_LIMIT_EXCEEDED',
  'XLSX_HEADER_INVALID', 'XLSX_COLUMN_COUNT_INVALID', 'XLSX_CELL_INVALID', 'XLSX_FORMULA_FORBIDDEN',
  'FINANCE_IMPORT_PROVIDER_REQUIRED', 'FINANCE_IMPORT_PARTNER_REQUIRED',
  'FINANCE_IMPORT_PERIOD_INVALID', 'FINANCE_IMPORT_CURRENCY_REQUIRED', 'FINANCE_IMPORT_CURRENCY_UNSUPPORTED',
  'FINANCE_IMPORT_OPENING_INVALID', 'FINANCE_IMPORT_CLOSING_INVALID',
  'FINANCE_STATEMENT_DUPLICATE', 'FINANCE_RECONCILIATION_DUPLICATE', 'FINANCE_IMPORT_ROW_COUNT_MISMATCH',
