import { jsonResponse, type LocalHandler } from '../../localinfra/src/Http';
...
export function secretStoreHandler(catalog: SecretReader, access: string | WorkloadResourceAuthorization): LocalHandler {
  ...
  return async request => {
    ...
    authorization.require(workload, reference);
