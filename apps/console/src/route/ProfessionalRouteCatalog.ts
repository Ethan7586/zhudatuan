...
>>>>>>> 018b2a71 (chore(release): capture current production source)
  ...
  route('referralsettings', 'referral/settings', /^referral\/settings$/, '分销设定', '招募、绑定、结算和提现策略', '业务运营', 'channel',
    'referral.settings.read'),
  route('referralproducts', 'referral/products', /^referral\/products$/, '分销商品', '导购商品与返佣比例', '业务运营', 'channel',
    'referral.products.read'),
  route('referralreview', 'referral/review', /^referral\/review$/, '分销审核', '会员申请与运营审核', '业务运营', 'channel',
    'referral.members.read', ['referral.members.read', 'referral.members.approve', 'referral.members.disqualify']),
  route('referralbindings', 'referral/bindings', /^referral\/bindings$/, '分销关系', '客户与导购的一层绑定关系', '业务运营', 'channel',
    'referral.bindings.read'),
  route('referralwithdrawals', 'referral/withdrawals', /^referral\/withdrawals$/, '佣金提现', '已结算佣金与可提现余额', '财务运营', 'finance',
