...
import { CART_EXPERIENCE_PORT, CHECKOUT_EXPERIENCE_PORT, EXPERIENCE_DIMENSION_PORT, EXPERIENCE_READ_PORT } from './public';
...
export const Manifest = defineModuleManifest({
  ...
  ports: [CART_EXPERIENCE_PORT, CHECKOUT_EXPERIENCE_PORT, EXPERIENCE_DIMENSION_PORT, EXPERIENCE_READ_PORT],
