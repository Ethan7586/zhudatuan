...
const REGISTRATION_TARGET_VERSION = '20260903105000';
const REGISTRATION_TARGET_CHECKSUM = '382abadcefe08c037c15d34d56af7f85236368b199f382cfa71ac63f2bef77cf';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260903105000_initialize_storefront_qualification.sql') valid`,
