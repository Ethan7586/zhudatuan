...
describe('runtime configuration schema', () => {
  ...
  it('accepts only the fail-closed registration API dependency allowlist', () => {
    const registration = {
      ...
      API_ALLOWED_ORIGINS: 'https://accounts.zhudatuan.com,https://console.zhudatuan.com,https://hbbtzn.com,https://zhudatuan.com',
      AUTH_RETURN_TARGETS: '{"console":"https://console.zhudatuan.com","storefront":"https://hbbtzn.com","store":"https://console.zhudatuan.com/entrances/store","supplier":"https://console.zhudatuan.com/entrances/supplier"}',
