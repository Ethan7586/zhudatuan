...
export const CardLibrarySchema = z
  .object({
    ...
    total_count: z.nullable(DatabaseIntegerSchema).optional(),
    success_count: z.nullable(DatabaseIntegerSchema).optional(),
    failure_count: z.nullable(DatabaseIntegerSchema).optional(),
  })
  .passthrough();
