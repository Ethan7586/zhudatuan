...
function bindCurrentRead(client: OperationExecutor): OperationMethod<"cart.current.read"> { return bindOperation(client, defineOperation({"id":"cart.current.read","method":"GET","path":"/api/v1/carts/current","audience":"storefront","targets":["storefront"],"responseMode":"json","idempotent":true,"timeout":500})); }
...
function bindItemsPut(client: OperationExecutor): OperationMethod<"cart.items.put"> { return bindOperation(client, defineOperation({"id":"cart.items.put","method":"PUT","path":"/api/v1/carts/current/items/{listingid}","audience":"storefront","targets":["storefront"],"responseMode":"json","idempotent":true,"timeout":800})); }
...
function bindItemsBatch(client: OperationExecutor): OperationMethod<"cart.items.batch"> { return bindOperation(client, defineOperation({"id":"cart.items.batch","method":"POST","path":"/api/v1/carts/current/items/batches","audience":"storefront","targets":["storefront"],"responseMode":"json","idempotent":false,"timeout":800})); }
