...
追溯补充（RV-0074）：提交 `a4ca80f3fe0fc4562c4463372c2a78f4ab9b85f2` 新增 DC-0090 时，累计从 GX 44 直接写为 GX 46，但正文仅登记一个 `seed/cleanup` 配对职责；这说明其中一个差额有计数来源，却没有可独立命名的第二对象。提交 `e31722a8c083b9d0eb18d140d2eac02ac3de50dd` 则正常以 GX-0041 将 51 增至 52。两项都不能据此补造 GX ID 或改变 DC-0090 的成对恢复语义；余下计数差额继续保留为未知。
