...
import { PAYMENT_BODY_SCHEMAS, PAYMENT_QUERY_SCHEMAS, PAYMENT_OUTPUT_SCHEMAS } from '@shop/contract/schema/Payment';
...
export function bindIntentsRead(client: OperationExecutor): OperationMethod<"payment.intents.read"> { return bindOperation(client, defineOperation({ ...{"id":"payment.intents.read","method":"GET","path":"/api/v1/payments/intents/{paymentid}","audience":"storefront","targets":["storefront","miniapp"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","ORIGIN_REQUIRED","PERMISSION_DENIED","RATE_LIMITED","RESOURCE_NOT_FOUND","SCOPE_DENIED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(PAYMENT_QUERY_SCHEMAS.PaymentIntentsReadInput, ["paymentid"] as const, false), output: exactOperationOutputFrom(PAYMENT_OUTPUT_SCHEMAS.PaymentIntentsReadOutput) })); }
...
export function bindRecoveriesRead(client: OperationExecutor): OperationMethod<"payment.recoveries.read"> { return bindOperation(client, defineOperation({ ...{"id":"payment.recoveries.read","method":"GET","path":"/api/v1/payments/recoveries","audience":"console","targets":["console","store"],"responseMode":"json","idempotencyPolicy":"none","idempotent":true,"timeout":500,"errorUnion":["AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","INTERNAL_ERROR","PAYMENT_REFUND_EXCEEDS_AVAILABLE","PERMISSION_DENIED","RATE_LIMITED","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(PAYMENT_QUERY_SCHEMAS.PaymentRecoveriesReadInput, [] as const, false), output: exactOperationOutputFrom(PAYMENT_OUTPUT_SCHEMAS.PaymentRecoveriesReadOutput) })); }
...
export function bindRecoveriesResolve(client: OperationExecutor): OperationMethod<"payment.recoveries.resolve"> { return bindOperation(client, defineOperation({ ...{"id":"payment.recoveries.resolve","method":"POST","path":"/api/v1/payments/recoveries/{caseid}/resolutions","audience":"console","targets":["console","store"],"responseMode":"json","idempotencyPolicy":"required","idempotent":true,"timeout":800,"errorUnion":["ACTION_PROOF_INVALID","ACTION_PROOF_REPLAYED","ACTION_PROOF_REQUIRED","AUTHENTICATION_REQUIRED","AUTHORIZATION_DENIED","CAPABILITY_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","CSRF_TOKEN_INVALID","DEADLINE_EXCEEDED","EXPECTED_VERSION_INVALID","EXPECTED_VERSION_REQUIRED","IDEMPOTENCY_CONFLICT","IDEMPOTENCY_KEY_REQUIRED","INTERNAL_ERROR","MAKER_CHECKER_SEPARATION_REQUIRED","ORIGIN_REQUIRED","PAYMENT_REFUND_EXCEEDS_AVAILABLE","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","SCOPE_DENIED","STEPUP_REQUIRED","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(PAYMENT_BODY_SCHEMAS.PaymentRecoveriesResolveInput, ["caseid"] as const, true), output: exactOperationOutputFrom(PAYMENT_OUTPUT_SCHEMAS.PaymentRecoveriesResolveOutput) })); }
...
export function bindWebhooksWechat(client: OperationExecutor): OperationMethod<"payment.webhooks.wechat"> { return bindOperation(client, defineOperation({ ...{"id":"payment.webhooks.wechat","method":"POST","path":"/api/v1/webhooks/wechat/payment","audience":"webhook","targets":[],"responseMode":"json","idempotencyPolicy":"provider","idempotent":true,"timeout":500,"errorUnion":["AUTHORIZATION_DENIED","CONTENT_TYPE_UNSUPPORTED","CONTRACT_VERSION_UNSUPPORTED","DEADLINE_EXCEEDED","IDEMPOTENCY_CONFLICT","INTERNAL_ERROR","PAYMENT_REFUND_EXCEEDS_AVAILABLE","PERMISSION_DENIED","RATE_LIMITED","REQUEST_BODY_TOO_LARGE","REQUEST_JSON_INVALID","URL_SENSITIVE_DATA_FORBIDDEN","VALIDATION_FAILED"]}, input: exactOperationInputFrom(PAYMENT_BODY_SCHEMAS.PaymentWebhooksWechatInput, [] as const, true), output: exactOperationOutputFrom(PAYMENT_OUTPUT_SCHEMAS.PaymentWebhooksWechatOutput) })); }
