...
const REGISTRATION_TARGET_VERSION = '20260903106000';
const REGISTRATION_TARGET_CHECKSUM = '44bbc40daf78e233a94bcda38e9323e3fb874d892393291943c9f38b00228d87';
  ...
  private async assertTarget(client: PoolClient): Promise<void> {
    const result = await client.query<{ readonly valid: boolean }>(`select
      ...
      and exists(select 1 from supabase_migrations.schema_migrations where version=$1
        and name='20260903106000_governance_invitation_tree_visibility.sql') valid`,
