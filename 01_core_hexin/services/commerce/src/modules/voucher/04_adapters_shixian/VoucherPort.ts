...
export type { VoucherChoice, VoucherRefund, VoucherTender } from '../01_public_gongkai/VoucherPort';

/** Public voucher boundary. It owns eligibility, locks, state events, redemption, reversal, and accounting facts. */
export class VoucherPort implements VoucherGateway {
  constructor(private readonly finance: VoucherFinancePort) {}
