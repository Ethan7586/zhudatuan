...
describe('queryCondition', () => {
  it.each([
    ...
    [{ pending: false, fetching: false, error: { kind: 'api', code: 'PERMISSION_DENIED', retryable: false }, empty: true }, 'forbidden'],
    ...
    [{ pending: false, fetching: false, error: { kind: 'transport', code: 'UNAVAILABLE', retryable: true }, empty: true }, 'unavailable'],
