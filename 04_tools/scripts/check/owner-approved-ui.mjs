...
const manifestPath = resolve(repositoryRoot, '02_platform_pingtai/config/owner-approved-ui.json');
...
if (!deliverySource.includes('sourceOfTruth: 02_platform_pingtai/config/owner-approved-ui.json')) throw new Error('deployment:SOURCE_OF_TRUTH_MISSING');
