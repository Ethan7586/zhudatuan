...
for (const [script, loader] of [['scripts/build-web-tokens.mjs', false], ['scripts/build-miniapp-theme.mjs', false],
  ['scripts/build-miniapp-environment.mjs', true], ['scripts/build-miniapp-contract.mjs', true], ['scripts/build-runtime-config.mjs', false]]) {
