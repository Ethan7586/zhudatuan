...
export function emptyTemplate(id: string, channel: NotificationChannel): TemplateEditor {
  return { kind: 'template', mode: 'create', id, channel, eventType: '', version: 1, variables: '{}', samples: '{}', providerTemplate: '', subject: '', body: '', purpose: 'transactional', mandatory: false, status: 'draft', proof: '', confirmed: false };
}
