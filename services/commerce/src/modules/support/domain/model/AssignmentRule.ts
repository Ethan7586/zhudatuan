...
export class AssignmentRule {
  constructor(
    ...
    if (!id || !scope || !skill || priorities.length === 0 || priorities.some((priority) => !['low', 'normal', 'high', 'urgent'].includes(priority)) || !Number.isSafeInteger(weight) || weight < 1 || weight > 1000) {
