...
describe('Referral MVVM workspace', () => {
  ...
  it('executes a real setting command with version, proof, identity and authoritative reread', async () => {
    ...
    expect(command?.body).toEqual({ enabled: true, recruitEnabled: true, reviewRequired: true, rewardEnabled: true, bindingMode: 'days', firstTouchDays: 7, freezeDays: 7, settlementTrigger: 'received', rateBasisPoints: 500, minimumWithdrawalMinor: 1000, monthlyWithdrawalLimit: 3, currency: 'CNY', expectedVersion: 7, reason: '调整年度分销政策' });
