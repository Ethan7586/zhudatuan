...
import type { DirectoryApplyKind, DirectoryCounts } from '../../domain/model/DirectoryDiff';
export type { DirectoryApplyKind, DirectoryCounts } from '../../domain/model/DirectoryDiff';
...
export interface DirectoryRepository {
  ...
  previewDepartures(context: ReadTransactionContext, connection: string, run: string): Promise<readonly DirectoryDeparture[]>;
  departures(context: ReadTransactionContext, connection: string): Promise<readonly DirectoryDeparture[]>;
  recordDepartures(context: WriteTransactionContext, run: string, count: number): Promise<void>;
