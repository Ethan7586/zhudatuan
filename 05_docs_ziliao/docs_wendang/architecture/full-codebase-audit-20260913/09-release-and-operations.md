...
## 25. AU-022 Vendor Core发布与运维边界

- `@shop/vendorcore`没有独立镜像、进程、端口或target；被JD、Tmall、Wanlian、Wenxuan等7个Provider包编入Commerce OCI，Cakeuncle只复用其连接/限流/circuit/error组件。
