...
export const VERIFICATION_OPERATION_IDS = /* @__PURE__ */ Object.freeze([
...
export function createFetchVerification(baseUrl: string): VerificationOperations {
  return createVerificationOperations(new ApiClient(baseUrl, new FetchTransport()));
}

export function createVerificationOperations(client: OperationExecutor): VerificationOperations {
...
export function createFetchVerificationChallengesIssue(baseUrl: string): OperationMethod<"verification.challenges.issue"> {
  return bindChallengesIssue(new ApiClient(baseUrl, new FetchTransport()));
}

function bindChallengesIssue(client: OperationExecutor): OperationMethod<"verification.challenges.issue"> {
  return bindOperation(client, defineContractOperation({"id":"verification.challenges.issue","method":"POST","path":"/api/v1/verifications/challenges","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindSessionsRead(client: OperationExecutor): OperationMethod<"verification.sessions.read"> {
  return bindOperation(client, defineContractOperation({"id":"verification.sessions.read","method":"GET","path":"/api/v1/verifications/sessions","audience":"member","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}

export function createFetchVerificationChallengesVerify(baseUrl: string): OperationMethod<"verification.challenges.verify"> {
  return bindChallengesVerify(new ApiClient(baseUrl, new FetchTransport()));
}

function bindChallengesVerify(client: OperationExecutor): OperationMethod<"verification.challenges.verify"> {
  return bindOperation(client, defineContractOperation({"id":"verification.challenges.verify","method":"POST","path":"/api/v1/verifications/challenges/{challengeid}/verification","audience":"operator","idempotent":false,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
...
function bindHistoryRead(client: OperationExecutor): OperationMethod<"verification.history.read"> {
  return bindOperation(client, defineContractOperation({"id":"verification.history.read","method":"GET","path":"/api/v1/verifications/history","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}

export function createFetchVerificationDevicesRead(baseUrl: string): OperationMethod<"verification.devices.read"> {
  return bindDevicesRead(new ApiClient(baseUrl, new FetchTransport()));
}

function bindDevicesRead(client: OperationExecutor): OperationMethod<"verification.devices.read"> {
  return bindOperation(client, defineContractOperation({"id":"verification.devices.read","method":"GET","path":"/api/v1/verifications/devices","audience":"operator","idempotent":true,"idempotency":"none","expectedVersion":"none","execution":"sync","availability":"runtime"}));
}

export function createFetchVerificationDevicesManage(baseUrl: string): OperationMethod<"verification.devices.manage"> {
  return bindDevicesManage(new ApiClient(baseUrl, new FetchTransport()));
}

function bindDevicesManage(client: OperationExecutor): OperationMethod<"verification.devices.manage"> {
  return bindOperation(client, defineContractOperation({"id":"verification.devices.manage","method":"PUT","path":"/api/v1/verifications/devices/{deviceid}","audience":"operator","idempotent":true,"idempotency":"required","expectedVersion":"optional","execution":"sync","availability":"runtime"}));
}
