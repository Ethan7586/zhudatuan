...
function memberReads(overrides: Readonly<Record<string, unknown>> = {}) {
  return { search: vi.fn(async () => Object.freeze([])), profiles: vi.fn(async () => Object.freeze([])), principals: vi.fn(async () => Object.freeze([])), ...overrides } as never;
}
