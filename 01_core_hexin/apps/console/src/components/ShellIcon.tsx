export type ShellIconName = 'applications' | 'bell' | 'building' | 'channel' | 'chevron' | 'collapse' | 'control'
  | 'finance' | 'menu' | 'members' | 'orders' | 'products' | 'search' | 'supply' | 'support' | 'system' | 'tasks' | 'trend' | 'voucher';
...
const paths: Readonly<Record<ShellIconName, readonly string[]>> = Object.freeze({
  ...
  supply: ['M7 7a3 3 0 1 0 0-6 3 3 0 0 0 0 6', 'M17 23a3 3 0 1 0 0-6 3 3 0 0 0 0 6', 'M17 7a3 3 0 1 0 0-6 3 3 0 0 0 0 6', 'M9.7 5.5h4.6', 'm8.6 8.8 6.8 6.4', 'M7 8.5v7a3 3 0 0 0 3 3h4'],
