...
create policy migrationaccess on reporting.period for all to shopmigration using(true) with check(true);
create policy migrationaccess on reporting.factrevision for all to shopmigration using(true) with check(true);
create policy migrationaccess on reporting.orderrevision for all to shopmigration using(true) with check(true);
create policy migrationaccess on reporting.financerevision for all to shopmigration using(true) with check(true);
