...
目前沒有一套名為 `hbbtzn` 的獨立 App、Service 或資料庫代碼。它實際由歷史 Smart Wing 域名／部署配置與築大團共享制品組成。因此本子項目不複製 `01_core_hexin/apps/`、`01_core_hexin/services/`、`01_core_hexin/packages/` 或 `02_platform_pingtai/database/`，也不建立第二套代碼 fork。
...
共享代碼仍位於 `../../../../01_core_hexin/apps/`、`../../../../01_core_hexin/services/`、`../../../../01_core_hexin/packages/` 與 `../../../database/`。正式制品真值仍只有 [`../../../config/artifacts.json`](../../../config/artifacts.json)；本子項目不得自行增加 App、Service 或合同，也不得加入根 npm Workspace。
...
- 舊部署參考：`../../aliyun/delivery.yml` 與 `../../storefront-compatibility/`
- 歷史代碼真值：`/Users/Ethan/Desktop/Projects/zhudatuan/archives/smart-wing/` 與 `/Users/Ethan/Desktop/Projects/zhudatuan/archives/smart-wing-20260826/`
