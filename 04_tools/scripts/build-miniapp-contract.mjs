...
import { DEEP_LINK_ROUTES } from '../../01_core_hexin/packages/contract/src/DeepLinkContract.ts';
import { EXPERIENCE_ACTIONS, EXPERIENCE_COMPONENTS, EXPERIENCE_VERSION } from '../../01_core_hexin/packages/contract/src/ExperienceContract.ts';

const root = resolve(import.meta.dirname, '../..');
const experienceTarget = join(root, '01_core_hexin/apps/miniapp/miniprogram/domain/experience.js');
const deepLinkTarget = join(root, '01_core_hexin/apps/miniapp/miniprogram/domain/deeplink.js');
