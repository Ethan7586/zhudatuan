...
const artifacts = [
  ...
  ['store', 'apps/store/dist', budgets.storeInitialGzipKb, budgets.lazyFeatureGzipKb],
  ['supplier', 'apps/supplier/dist', budgets.supplierInitialGzipKb, budgets.lazyFeatureGzipKb],
...
const miniapp = join(root, 'apps/miniapp/miniprogram');
if (!existsSync(miniapp)) findings.push('BUNDLE_MISSING apps/miniapp/miniprogram');
else {
