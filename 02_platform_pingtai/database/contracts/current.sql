...
insert into runtime.operation(id,owner,method,path,contract_version) values
  ...
  ('member.storefront.members.read','member','GET','/api/v1/member/storefront-members','1.0.0'),
  ...
  ('member.sovereignty.upgrade','member','POST','/api/v1/members/me/sovereignty','1.0.0'),
  ...
  ('risk.cases.review','risk','PUT','/api/v1/risks/cases/{caseid}','1.0.0'),
  ...
  ('identity.storefronts.read','identity','POST','/api/v1/identity/storefronts/resolve','1.0.0'),
...
insert into capability.capability(id,kind,name,version,status) values
  ...
  ('member.storefront.members.read','operation','member.storefront.members.read',1,'active'),
  ...
  ('member.sovereignty.upgrade','operation','member.sovereignty.upgrade',1,'active'),
  ...
  ('finance.withdrawals.read','operation','finance.withdrawals.read',1,'active'),
  ('finance.withdrawals.create','operation','finance.withdrawals.create',1,'active'),
  ('finance.withdrawals.decide','operation','finance.withdrawals.decide',1,'active'),
  ('finance.withdrawals.recover','operation','finance.withdrawals.recover',1,'active'),
  ('finance.holds.read','operation','finance.holds.read',1,'active'),
  ('finance.periods.read','operation','finance.periods.read',1,'active'),
  ('finance.periods.manage','operation','finance.periods.manage',1,'active'),
  ...
  ('invoice.requests.decide','operation','invoice.requests.decide',1,'active'),
  ('invoice.requests.red','operation','invoice.requests.red',1,'active'),
  ...
  ('risk.cases.review','operation','risk.cases.review',1,'active'),
  ...
  ('identity.storefronts.read','operation','identity.storefronts.read',1,'active'),
...
insert into capability.operation(operation_id,capability_id,permission_code,audience) values
  ...
  ('member.storefront.members.read','member.storefront.members.read','member.read','operator'),
  ...
  ('member.sovereignty.upgrade','member.sovereignty.upgrade','member.profile.read','member'),
  ...
  ('catalog.listings.read','catalog.listings.read','catalog.listing.read','member'),
  ...
  ('pricing.offers.read','pricing.offers.read','pricing.offer.read','member'),
  ('inventory.availability.read','inventory.availability.read','inventory.read','member'),
  ...
  ('cart.current.read','cart.current.read','cart.read','member'),
  ('cart.items.put','cart.items.put','cart.manage','member'),
  ('cart.items.batch','cart.items.batch','cart.manage','member'),
  ...
  ('order.aftersales.apply','order.aftersales.apply','order.aftersale.apply','member'),
  ...
  ('voucher.bindings.read','voucher.bindings.read','voucher.binding.read','member'),
  ('voucher.bindings.manage','voucher.bindings.manage','voucher.binding.manage','operator'),
  ('voucher.redemptions.read','voucher.redemptions.read','voucher.redemption.read','member'),
  ...
  ('benefit.accounts.read','benefit.accounts.read','benefit.read','member'),
  ...
  ('support.cases.create','support.cases.create','support.case.create','member'),
  ...
  ('notification.notifications.read','notification.notifications.read','notification.read','member'),
  ...
  ('risk.cases.review','risk.cases.review','risk.manage','operator'),
  ...
  ('identity.storefronts.read','identity.storefronts.read',null,'public'),
...
insert into runtime.schemaversion(version,checksum) values('20260821032000','ff04b20694dc426dc6e144f4dfcc44cd0fd98d56eeae294c793a51b36bcf85ff');
