...
flowchart TB
    ...
    Commerce[01_core_hexin/services/commerce]
    CompatAPI["01_core_hexin/services/commerce-api<br/>Compatibility BFF"]
...
Ethan 确认这些决策后，应将最终结论写入 `05_docs_ziliao/docs_wendang/zdt.md`，替代本文件的“草图”状态。
