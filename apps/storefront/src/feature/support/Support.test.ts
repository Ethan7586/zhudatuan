...
describe('support mapping', () => {
  it('keeps member ticket and encrypted-message projections explicit', () => {
    ...
    const conversation = mapConversation({
      items: [{ id: 'message:1', clientMessageId: 'client:1', conversationId: 'conversation:1', authorType: 'agent', authorId: 'agent:1', kind: 'text', visibility: 'external', body: '已受理', sequence: 1, version: 1, createdAt: '2026-08-31T00:01:00Z' }],
      attachments: [],
