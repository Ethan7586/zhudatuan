...
export const PERMISSION_CATALOG = Object.freeze([
  ...
  definition('approval.read', 'approval', 'low', operator),
  definition('approval.template.manage', 'approval', 'high', operator),
  definition('approval.task.decide', 'approval', 'critical', operator),
