...
export function exportHeader(report: ExportReport): readonly string[] {
  if (report === 'metrics') return Object.freeze(['metricCode', 'metricVersion', 'scope', 'periodFrom', 'periodTo', 'timezone', 'dimensions', 'value', 'unit', 'currency', 'watermark', 'projectionVersion', 'filter', 'generatedAt']);
