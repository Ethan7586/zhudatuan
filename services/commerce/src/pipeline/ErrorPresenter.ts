...
import { OperationRejection } from './OperationRejection';
import { json, type HttpResponse } from '../platform/http/HttpResponse';
...
function operationMapped(code: string, requestId: string, operation: OperationId, details?: Readonly<Record<string, import('../platform/error/ApplicationError').ErrorDetail>>): HttpResponse {
...
function catalogued(code: string, requestId: string, details?: Readonly<Record<string, import('../platform/error/ApplicationError').ErrorDetail>>): HttpResponse {
...
function allowedDetails(allowed: readonly string[], details: Readonly<Record<string, import('../platform/error/ApplicationError').ErrorDetail>> | undefined) {
