...
export class DimensionPresetReader {
  constructor(private readonly metrics: MetricReader) {}

  async readCustomerMembers(input: OperationInputFor<'reporting.sales.read'>, context: HandlerContext<'reporting.sales.read'>): Promise<OperationReply<OperationOutputFor<'reporting.sales.read'>>> {
