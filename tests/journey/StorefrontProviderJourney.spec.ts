...
storefrontJourney('storefront provider fulfillment journey', {
  ...
  sources: ['services/commerce/src/bootstrap/ProviderRuntime.ts', 'services/commerce/src/bootstrap/ExtensionRegistry.ts', 'services/commerce/src/modules/fulfillment/infrastructure/persistence/PgFulfillmentJobProcess.ts'],
